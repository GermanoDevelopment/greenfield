"use strict";
(self["webpackChunkdemo_video"] = self["webpackChunkdemo_video"] || []).push([["701"], {
7553(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  N: () => (AC3_SAMPLE_RATES),
  P: () => (EAC3_REDUCED_SAMPLE_RATES)
});
/*!
...
1390(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  _: () => (Bitstream)
});
/*!
...
9086(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  H: () => (AdtsDemuxer),
  s: () => (SAMPLES_PER_AAC_FRAME)
});
/* import */ var _shared_aac_misc_js__rspack_import_4 = __webpack_require__(1299);
/* import */ var _demuxer_js__rspack_import_0 = __webpack_require__(7202);
/* import */ var _id3_js__rspack_import_2 = __webpack_require__(7576);
/* import */ var _metadata_js__rspack_import_5 = __webpack_require__(5165);
/* import */ var _misc_js__rspack_import_1 = __webpack_require__(3912);
/* import */ var _packet_js__rspack_import_6 = __webpack_require__(3936);
/* import */ var _reader_js__rspack_import_7 = __webpack_require__(7735);
/* import */ var _adts_reader_js__rspack_import_3 = __webpack_require__(8475);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class AdtsDemuxer extends _demuxer_js__rspack_import_0/* .Demuxer */.B {
    constructor(input) {
        super(input);
        ...
        this.trackBackings = [];
        this.readingMutex = new _misc_js__rspack_import_1/* .AsyncMutex */.aD();
    ...
    async readMetadata() {
        return this.metadataPromise ??= (async () => {
            ...
            (0,_misc_js__rspack_import_1/* .assert */.vA)(this.firstFrameHeader);
    ...
    async advanceReader() {
        if (this.lastLoadedPos === 0) {
            ...
            while (true) {
                let slice = this.reader.requestSlice(this.lastLoadedPos, _id3_js__rspack_import_2/* .ID3_V2_HEADER_SIZE */.sY);
                if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(slice))
                    slice = await slice;
                if (!slice) {
                    this.lastSampleLoaded = true;
                    return;
                }
                const id3V2Header = (0,_id3_js__rspack_import_2/* .readId3V2Header */.IX)(slice);
                if (!id3V2Header) {
                    break;
                }
        ...
        let slice = this.reader.requestSliceRange(this.lastLoadedPos, _adts_reader_js__rspack_import_3/* .MIN_ADTS_FRAME_HEADER_SIZE */.gc, _adts_reader_js__rspack_import_3/* .MAX_ADTS_FRAME_HEADER_SIZE */.Y$);
        if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(slice))
            slice = await slice;
        if (!slice) {
            this.lastSampleLoaded = true;
        ...
        const header = (0,_adts_reader_js__rspack_import_3/* .readAdtsFrameHeader */.lh)(slice);
        if (!header) {
            this.lastSampleLoaded = true;
            return;
        }
        ...
        const sampleRate = _shared_aac_misc_js__rspack_import_4/* .aacFrequencyTable */.Im[header.samplingFrequencyIndex];
        (0,_misc_js__rspack_import_1/* .assert */.vA)(sampleRate !== undefined);
    ...
    async getMetadataTags() {
        ...
        try {
            ...
            let currentPos = 0;
            while (true) {
                let headerSlice = this.reader.requestSlice(currentPos, _id3_js__rspack_import_2/* .ID3_V2_HEADER_SIZE */.sY);
                if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(headerSlice))
                    headerSlice = await headerSlice;
                if (!headerSlice)
                    break;
                const id3V2Header = (0,_id3_js__rspack_import_2/* .readId3V2Header */.IX)(headerSlice);
                if (!id3V2Header) {
                    break;
                }
                let contentSlice = this.reader.requestSlice(headerSlice.filePos, id3V2Header.size);
                if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(contentSlice))
                    contentSlice = await contentSlice;
                if (!contentSlice)
                    break;
                (0,_id3_js__rspack_import_2/* .parseId3V2Tag */.cG)(contentSlice, id3V2Header, this.metadataTags);
...
class AdtsAudioTrackBacking {
    ...
    getLanguageCode() {
        return _misc_js__rspack_import_1/* .UNDETERMINED_LANGUAGE */.IR;
    }
    getCodec() {
        return 'aac';
    }
    getInternalCodecId() {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.firstFrameHeader);
        return this.demuxer.firstFrameHeader.objectType;
    }
    getNumberOfChannels() {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.firstFrameHeader);
        const numberOfChannels = _shared_aac_misc_js__rspack_import_4/* .aacChannelMap */.Ti[this.demuxer.firstFrameHeader.channelConfiguration];
        (0,_misc_js__rspack_import_1/* .assert */.vA)(numberOfChannels !== undefined);
        return numberOfChannels;
    }
    getSampleRate() {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.firstFrameHeader);
        const sampleRate = _shared_aac_misc_js__rspack_import_4/* .aacFrequencyTable */.Im[this.demuxer.firstFrameHeader.samplingFrequencyIndex];
        (0,_misc_js__rspack_import_1/* .assert */.vA)(sampleRate !== undefined);
        return sampleRate;
    }
    getDisposition() {
        return {
            ..._metadata_js__rspack_import_5/* .DEFAULT_TRACK_DISPOSITION */.gM,
        };
    }
    ...
    async getPacketAtIndex(sampleIndex, options) {
        ...
        if (options.metadataOnly) {
            data = _packet_js__rspack_import_6/* .PLACEHOLDER_DATA */.T;
        }
        else {
            ...
            data = (0,_reader_js__rspack_import_7/* .readBytes */.io)(slice, rawSample.dataSize);
        }
        return new _packet_js__rspack_import_6/* .EncodedPacket */.Z(data, 'key', rawSample.timestamp, rawSample.duration, sampleIndex, rawSample.dataSize);
    }
    ...
    async getNextPacket(packet, options) {
        ...
        try {
            const sampleIndex = (0,_misc_js__rspack_import_1/* .binarySearchExact */.pl)(this.demuxer.loadedSamples, packet.timestamp, x => x.timestamp);
            if (sampleIndex === -1) {
    ...
    async getPacket(timestamp, options) {
        ...
        try {
            while (true) {
                const index = (0,_misc_js__rspack_import_1/* .binarySearchLessOrEqual */.eE)(this.demuxer.loadedSamples, timestamp, x => x.timestamp);
...
8475(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Y$: () => (MAX_ADTS_FRAME_HEADER_SIZE),
  gc: () => (MIN_ADTS_FRAME_HEADER_SIZE),
  lh: () => (readAdtsFrameHeader)
});
/* import */ var _shared_bitstream_js__rspack_import_1 = __webpack_require__(1390);
/* import */ var _reader_js__rspack_import_0 = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
const readAdtsFrameHeader = (slice) => {
    ...
    const bytes = (0,_reader_js__rspack_import_0/* .readBytes */.io)(slice, 9); // 9 with CRC, 7 without CRC
    const bitstream = new _shared_bitstream_js__rspack_import_1/* .Bitstream */._(bytes);
...
3373(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  U4: () => (createAes128CbcDecryptStream),
  UP: () => (Aes128CbcContext),
  ye: () => (AES_128_BLOCK_SIZE)
});
/* import */ var _misc_js__rspack_import_0 = __webpack_require__(3912);
/* import */ var _reader_js__rspack_import_1 = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class Aes128CbcContext {
    ...
    init({ key, iv }) {
        (0,_misc_js__rspack_import_0/* .assert */.vA)(key.byteLength === 16);
        (0,_misc_js__rspack_import_0/* .assert */.vA)(iv.byteLength === 16);
        if (!tablesGenerated) {
            generateAesTables();
        }
...
const createAes128CbcDecryptStream = (reader, getInit, close) => {
    ...
    return new ReadableStream({
        pull: async (controller) => {
            ...
            if ((0,_misc_js__rspack_import_0/* .isThenable */.Qg)(nextSlice))
            ...
            const bytesToRead = sliceLength === requestedLength
                ...
                : sliceLength;
            const input = (0,_reader_js__rspack_import_1/* .readBytes */.io)(nextSlice, bytesToRead);
...
7202(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  B: () => (Demuxer)
});
/*!
...
4582(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  D: () => (FlacDemuxer)
});
/* import */ var _codec_data_js__rspack_import_4 = __webpack_require__(6297);
/* import */ var _demuxer_js__rspack_import_0 = __webpack_require__(7202);
/* import */ var _misc_js__rspack_import_1 = __webpack_require__(3912);
/* import */ var _packet_js__rspack_import_8 = __webpack_require__(3936);
/* import */ var _reader_js__rspack_import_3 = __webpack_require__(7735);
/* import */ var _metadata_js__rspack_import_7 = __webpack_require__(5165);
/* import */ var _flac_misc_js__rspack_import_6 = __webpack_require__(5828);
/* import */ var _shared_bitstream_js__rspack_import_5 = __webpack_require__(1390);
/* import */ var _id3_js__rspack_import_2 = __webpack_require__(7576);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
...
class FlacDemuxer extends _demuxer_js__rspack_import_0/* .Demuxer */.B {
    constructor(input) {
        super(input);
    ...
    async getTrackBackings() {
        await this.readMetadata();
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.trackBacking);
    ...
    async readMetadata() {
        return (this.metadataPromise ??= (async () => {
            ...
            while (true) {
                ...
                if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(contentSlice))
                    contentSlice = await contentSlice;
                (0,_misc_js__rspack_import_1/* .assert */.vA)(contentSlice);
                (0,_id3_js__rspack_import_2/* .parseId3V2Tag */.cG)(contentSlice, id3V2Header, this.metadataTags);
                currentPos = headerSlice.filePos + id3V2Header.size;
            }
            ...
            while (this.reader.fileSize === null
                ...
                if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(sizeSlice))
                    sizeSlice = await sizeSlice;
                currentPos += 4;
                if (sizeSlice === null) {
                    throw new Error(`Metadata block at position ${currentPos} is too small! Corrupted file.`);
                }
                (0,_misc_js__rspack_import_1/* .assert */.vA)(sizeSlice);
                const byte = (0,_reader_js__rspack_import_3/* .readU8 */.eo)(sizeSlice); // first bit: isLastMetadata, remaining 7 bits: metaBlockType
                const size = (0,_reader_js__rspack_import_3/* .readU24Be */.n2)(sizeSlice);
                const isLastMetadata = (byte & 0x80) !== 0;
                const metaBlockType = byte & 0x7f;
                switch (metaBlockType) {
                    case _codec_data_js__rspack_import_4/* .FlacBlockType.STREAMINFO */.A3.STREAMINFO: {
                        // Parse streaminfo block
                        // https://www.rfc-editor.org/rfc/rfc9639.html#section-8.2
                        let streamInfoBlock = this.reader.requestSlice(currentPos, size);
                        if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(streamInfoBlock))
                            streamInfoBlock = await streamInfoBlock;
                        (0,_misc_js__rspack_import_1/* .assert */.vA)(streamInfoBlock);
                        if (streamInfoBlock === null) {
                            throw new Error(`StreamInfo block at position ${currentPos} is too small! Corrupted file.`);
                        }
                        const streamInfoBytes = (0,_reader_js__rspack_import_3/* .readBytes */.io)(streamInfoBlock, 34);
                        const bitstream = new _shared_bitstream_js__rspack_import_5/* .Bitstream */._(streamInfoBytes);
                    ...
                    case _codec_data_js__rspack_import_4/* .FlacBlockType.VORBIS_COMMENT */.A3.VORBIS_COMMENT: {
                        ...
                        if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(vorbisCommentBlock))
                            vorbisCommentBlock = await vorbisCommentBlock;
                        (0,_misc_js__rspack_import_1/* .assert */.vA)(vorbisCommentBlock);
                        (0,_codec_data_js__rspack_import_4/* .readVorbisComments */.Oc)((0,_reader_js__rspack_import_3/* .readBytes */.io)(vorbisCommentBlock, size), this.metadataTags);
                        break;
                    }
                    case _codec_data_js__rspack_import_4/* .FlacBlockType.PICTURE */.A3.PICTURE: {
                        // Parse picture block
                        // https://www.rfc-editor.org/rfc/rfc9639.html#name-picture
                        let pictureBlock = this.reader.requestSlice(currentPos, size);
                        if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(pictureBlock))
                            pictureBlock = await pictureBlock;
                        (0,_misc_js__rspack_import_1/* .assert */.vA)(pictureBlock);
                        const pictureType = (0,_reader_js__rspack_import_3/* .readU32Be */.cN)(pictureBlock);
                        const mediaTypeLength = (0,_reader_js__rspack_import_3/* .readU32Be */.cN)(pictureBlock);
                        const mediaType = _misc_js__rspack_import_1/* .textDecoder.decode */.su.decode((0,_reader_js__rspack_import_3/* .readBytes */.io)(pictureBlock, mediaTypeLength));
                        const descriptionLength = (0,_reader_js__rspack_import_3/* .readU32Be */.cN)(pictureBlock);
                        const description = _misc_js__rspack_import_1/* .textDecoder.decode */.su.decode((0,_reader_js__rspack_import_3/* .readBytes */.io)(pictureBlock, descriptionLength));
                        pictureBlock.skip(4 + 4 + 4 + 4); // Skip width, height, color depth, number of indexed colors
                        const dataLength = (0,_reader_js__rspack_import_3/* .readU32Be */.cN)(pictureBlock);
                        const data = (0,_reader_js__rspack_import_3/* .readBytes */.io)(pictureBlock, dataLength);
    ...
    async readNextFlacFrame({ startPos, isFirstPacket, }) {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.audioInfo);
        ...
        while (true) {
            ...
            const nextByte = (0,_reader_js__rspack_import_3/* .readU8 */.eo)(slice);
            if (nextByte === 0xff) {
                const positionBeforeReading = slice.filePos;
                const byteAfterNextByte = (0,_reader_js__rspack_import_3/* .readU8 */.eo)(slice);
    ...
    readFlacFrameHeader({ slice, isFirstPacket, }) {
        ...
        const bytes = (0,_reader_js__rspack_import_3/* .readBytes */.io)(slice, 4);
        const bitstream = new _shared_bitstream_js__rspack_import_5/* .Bitstream */._(bytes);
        ...
        if (this.blockingBit === null) {
            (0,_misc_js__rspack_import_1/* .assert */.vA)(isFirstPacket);
        ...
        const blockSizeOrUncommon = (0,_flac_misc_js__rspack_import_6/* .getBlockSizeOrUncommon */.iv)(bitstream.readBits(4));
        if (!blockSizeOrUncommon) {
            // This cannot be a valid FLAC frame, the syncword was just coincidental
            return null;
        }
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.audioInfo);
        const sampleRateOrUncommon = (0,_flac_misc_js__rspack_import_6/* .getSampleRateOrUncommon */.oP)(bitstream.readBits(4), this.audioInfo.sampleRate);
        ...
        const num = (0,_flac_misc_js__rspack_import_6/* .readCodedNumber */.X7)(slice);
        const blockSize = (0,_flac_misc_js__rspack_import_6/* .readBlockSize */.f6)(slice, blockSizeOrUncommon);
        const sampleRate = (0,_flac_misc_js__rspack_import_6/* .readSampleRate */.Ld)(slice, sampleRateOrUncommon);
        if (sampleRate === null) {
            // This cannot be a valid FLAC frame, the syncword was just coincidental
            return null;
        }
        ...
        const crc = (0,_reader_js__rspack_import_3/* .readU8 */.eo)(slice);
        slice.skip(-size);
        slice.skip(-1);
        const crcCalculated = (0,_flac_misc_js__rspack_import_6/* .calculateCrc8 */.Be)((0,_reader_js__rspack_import_3/* .readBytes */.io)(slice, size));
    ...
    async advanceReader() {
        await this.readMetadata();
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.lastLoadedPos !== null);
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.audioInfo);
...
class FlacAudioTrackBacking {
    ...
    getNumberOfChannels() {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.audioInfo);
    ...
    getDisposition() {
        return {
            ..._metadata_js__rspack_import_7/* .DEFAULT_TRACK_DISPOSITION */.gM,
        };
    }
    async getDecoderConfig() {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.audioInfo);
    ...
    async getPacket(timestamp, options) {
        ...
        try {
            while (true) {
                const packetIndex = (0,_misc_js__rspack_import_1/* .binarySearchLessOrEqual */.eE)(this.demuxer.loadedSamples, timestamp, x => x.blockOffset / this.demuxer.audioInfo.sampleRate);
                if (packetIndex === -1) {
                    await this.demuxer.advanceReader();
                    continue;
                }
    ...
    async getPacketAtIndex(sampleIndex, options) {
        ...
        let data;
        if (options.metadataOnly) {
            data = _packet_js__rspack_import_8/* .PLACEHOLDER_DATA */.T;
        }
        else {
            ...
            data = (0,_reader_js__rspack_import_3/* .readBytes */.io)(slice, rawSample.byteSize);
        }
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.audioInfo);
        ...
        return new _packet_js__rspack_import_8/* .EncodedPacket */.Z(data, 'key', timestamp, duration, sampleIndex, rawSample.byteSize);
    }
...
5828(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Be: () => (calculateCrc8),
  Ld: () => (readSampleRate),
  X7: () => (readCodedNumber),
  f6: () => (readBlockSize),
  iv: () => (getBlockSizeOrUncommon),
  oP: () => (getSampleRateOrUncommon)
});
/* import */ var _shared_bitstream_js__rspack_import_0 = __webpack_require__(1390);
/* import */ var _misc_js__rspack_import_2 = __webpack_require__(3912);
/* import */ var _reader_js__rspack_import_1 = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
...
const readCodedNumber = (fileSlice) => {
    let ones = 0;
    const bitstream1 = new _shared_bitstream_js__rspack_import_0/* .Bitstream */._((0,_reader_js__rspack_import_1/* .readBytes */.io)(fileSlice, 1));
    ...
    const bitstream2 = new _shared_bitstream_js__rspack_import_0/* .Bitstream */._((0,_reader_js__rspack_import_1/* .readBytes */.io)(fileSlice, extraBytes));
...
const readBlockSize = (slice, blockSizeBits) => {
    if (blockSizeBits === 'uncommon-u16') {
        return (0,_reader_js__rspack_import_1/* .readU16Be */.mH)(slice) + 1;
    }
    else if (blockSizeBits === 'uncommon-u8') {
        return (0,_reader_js__rspack_import_1/* .readU8 */.eo)(slice) + 1;
    }
    else if (typeof blockSizeBits === 'number') {
        return blockSizeBits;
    }
    else {
        (0,_misc_js__rspack_import_2/* .assertNever */.xb)(blockSizeBits);
        (0,_misc_js__rspack_import_2/* .assert */.vA)(false);
    }
};
const readSampleRate = (slice, sampleRateOrUncommon) => {
    if (sampleRateOrUncommon === 'uncommon-u16') {
        return (0,_reader_js__rspack_import_1/* .readU16Be */.mH)(slice);
    }
    if (sampleRateOrUncommon === 'uncommon-u16-10') {
        return (0,_reader_js__rspack_import_1/* .readU16Be */.mH)(slice) * 10;
    }
    if (sampleRateOrUncommon === 'uncommon-u8') {
        return (0,_reader_js__rspack_import_1/* .readU8 */.eo)(slice);
    }
...
4824(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  a: () => (/* binding */ HlsDemuxer)
});
...
var src_demuxer = __webpack_require__(7202);
...
// EXTERNAL MODULE: ./node_modules/mediabunny/dist/modules/src/aes.js
var aes = __webpack_require__(3373);
// EXTERNAL MODULE: ./node_modules/mediabunny/dist/modules/src/input.js
var src_input = __webpack_require__(2030);
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/segmented-input.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class SegmentedInputInputTrackBacking {
    ...
    async getFirstPacket(options) {
        ...
        (0,misc/* .assert */.vA)(this.firstSegment);
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/hls/hls-segmented-input.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
    ...
    async updateSegments() {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (!line.startsWith('#')) {
                if (!prevLastSegment) {
                    ...
                    if (key && key.method === 'AES-128' && !key.iv) {
                        ...
                        const iv = new Uint8Array(aes/* .AES_128_BLOCK_SIZE */.ye);
            ...
            if (line.startsWith(hls_misc/* .TAG_EXTINF */.e9)) {
                ...
                const extinfContent = line.slice(hls_misc/* .TAG_EXTINF.length */.e9.length);
                ...
                const attributes = new hls_misc/* .AttributeList */.Hw(line.slice(hls_misc/* .TAG_MAP.length */.sA.length));
                ...
                const attributes = new hls_misc/* .AttributeList */.Hw(line.slice(hls_misc/* .TAG_KEY.length */.L2.length));
                ...
                if (method === 'NONE') {
                    ...
                    if (ivString) {
                        ...
                        hex = hex.padStart(aes/* .AES_128_BLOCK_SIZE */.ye * 2, '0');
                        iv = new Uint8Array(aes/* .AES_128_BLOCK_SIZE */.ye);
                        for (let i = 0; i < aes/* .AES_128_BLOCK_SIZE */.ye; i++) {
                            const startIndex = -aes/* .AES_128_BLOCK_SIZE */.ye * 2 + i;
                ...
                const value = line.slice(hls_misc/* .TAG_MEDIA_SEQUENCE.length */._2.length);
                ...
                const parsed = parseByteRange(line.slice(hls_misc/* .TAG_BYTERANGE.length */.v6.length));
                ...
                const dateTime = line.slice(hls_misc/* .TAG_PROGRAM_DATE_TIME.length */.bW.length);
                ...
                const value = line.slice(hls_misc/* .TAG_TARGETDURATION.length */.xe.length);
                ...
                const type = line.slice(hls_misc/* .TAG_PLAYLIST_TYPE.length */.zA.length);
        ...
        const input = new src_input/* .Input */.pd({
            source: new source/* .CustomPathedSource */.r3(hlsSegment.location.path, async (request) => {
                ...
                if (!hlsSegment.encryption
                    ...
                    const stream = (0,aes/* .createAes128CbcDecryptStream */.U4)(ciphertextReader, async () => {
                        ...
                        try {
                            ...
                            const keySlice = await keyReader.requestSlice(0, aes/* .AES_128_BLOCK_SIZE */.ye);
                            if (!keySlice) {
                                throw new Error('Invalid AES-128 key; expected at least 16 bytes of data.');
                            }
                            const key = (0,src_reader/* .readBytes */.io)(keySlice, aes/* .AES_128_BLOCK_SIZE */.ye);
            ...
            formats: this.input._formats.filter(x => !(x instanceof input_format/* .HlsInputFormat */.rp)),
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/hls/hls-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class HlsDemuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
        ...
        return this.metadataPromise ??= (async () => {
            ...
            for (let i = 1; i < lines.length; i++) {
                ...
                if (line.startsWith(hls_misc/* .TAG_STREAM_INF */.c$)) {
                    ...
                    const attributes = new hls_misc/* .AttributeList */.Hw(line.slice(hls_misc/* .TAG_STREAM_INF.length */.c$.length));
                    ...
                    const attributes = new hls_misc/* .AttributeList */.Hw(line.slice(hls_misc/* .TAG_I_FRAME_STREAM_INF.length */.g4.length));
                    ...
                    const attributes = new hls_misc/* .AttributeList */.Hw(line.slice(hls_misc/* .TAG_MEDIA.length */.EF.length));
            ...
            const internalTracksByVariant = await Promise.all(variantStreams.map(async (variantStream, i) => {
                ...
                const containsVideoCodecs = codecStrings.some(x => codec/* .VIDEO_CODECS.includes */.WN.includes((0,codec/* .inferCodecFromCodecString */.oU)(x)));
                const containsAudioCodecs = codecStrings.some(x => codec/* .AUDIO_CODECS.includes */.PP.includes((0,codec/* .inferCodecFromCodecString */.oU)(x)));
                ...
                for (const codecString of codecStrings) {
                    ...
                    if (codec/* .VIDEO_CODECS.includes */.WN.includes(inferredCodec)) {
                    ...
                    else if (codec/* .AUDIO_CODECS.includes */.PP.includes(inferredCodec)) {
...
__webpack_require__.d(__webpack_exports__, {
  DT: () => (TAG_I_FRAMES_ONLY),
  EF: () => (TAG_MEDIA),
  Hw: () => (AttributeList),
  L2: () => (TAG_KEY),
  _2: () => (TAG_MEDIA_SEQUENCE),
  bW: () => (TAG_PROGRAM_DATE_TIME),
  c$: () => (TAG_STREAM_INF),
  dY: () => (TAG_ENDLIST),
  e9: () => (TAG_EXTINF),
  g4: () => (TAG_I_FRAME_STREAM_INF),
  i$: () => (TAG_DISCONTINUITY),
  is: () => (HLS_MIME_TYPE),
  nf: () => (canIgnoreLine),
  sA: () => (TAG_MAP),
  v6: () => (TAG_BYTERANGE),
  xe: () => (TAG_TARGETDURATION),
  zA: () => (TAG_PLAYLIST_TYPE)
});
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
...
6244(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  D8: () => (prefer),
  Kh: () => (InputTrack),
  N0: () => (InputVideoTrack),
  NY: () => (queryInputTracks),
  Uj: () => (mergeInputTrackQueries),
  Yi: () => (InputAudioTrack),
  i8: () => (desc),
  vo: () => (toValidatedInputTrackQuery)
});
/* import */ var _codec_data_js__rspack_import_5 = __webpack_require__(6297);
/* import */ var _custom_coder_js__rspack_import_2 = __webpack_require__(8647);
/* import */ var _logging_js__rspack_import_3 = __webpack_require__(6103);
/* import */ var _media_sink_js__rspack_import_1 = __webpack_require__(388);
/* import */ var _misc_js__rspack_import_0 = __webpack_require__(3912);
/* import */ var _packet_js__rspack_import_4 = __webpack_require__(3936);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class InputTrack {
    ...
    async computeDuration(options) {
        ...
        return (0,_misc_js__rspack_import_0/* .roundToDivisor */.gl)(result, await this.getTimeResolution());
    }
    /**
    ...
    async computePacketStats(targetPacketCount = Infinity, options) {
        const sink = new _media_sink_js__rspack_import_1/* .EncodedPacketSink */.kQ(this);
...
const requireSync = (value, getterName, asyncName) => {
    if ((0,_misc_js__rspack_import_0/* .isThenable */.Qg)(value)) {
...
const toValidatedPredicate = (predicate) => {
    ...
    return predicate
        ? (track) => {
            ...
            if ((0,_misc_js__rspack_import_0/* .isThenable */.Qg)(result)) {
...
class InputVideoTrack extends InputTrack {
    ...
    async getPixelAspectRatio() {
        ...
        // so cheap
        return this._pixelAspectRatioCache ??= (0,_misc_js__rspack_import_0/* .simplifyRational */.Yf)({
    ...
    async canDecode() {
        try {
            ...
            (0,_misc_js__rspack_import_0/* .assert */.vA)(codec !== null);
            if (_custom_coder_js__rspack_import_2/* .customVideoDecoders.some */.wb.some(x => x.supports(codec, decoderConfig))) {
                return true;
            }
            ...
            _logging_js__rspack_import_3/* .Logging._error */.y._error('Error during decodability check:', error);
            return false;
        }
    }
    async determinePacketType(packet) {
        if (!(packet instanceof _packet_js__rspack_import_4/* .EncodedPacket */.Z)) {
        ...
        (0,_misc_js__rspack_import_0/* .assert */.vA)(decoderConfig);
        return (0,_codec_data_js__rspack_import_5/* .determineVideoPacketType */.PR)(codec, decoderConfig, packet.data);
    }
    /**
    ...
    async computeFrameRateMetrics(options = {}) {
        ...
        if (options.targetPacketCount !== undefined
            && (!(0,_misc_js__rspack_import_0/* .isNumber */.Et)(options.targetPacketCount) || options.targetPacketCount < 0)) {
...
class InputAudioTrack extends InputTrack {
    ...
    async canDecode() {
        try {
            ...
            const codec = await this._backing.getCodec();
            (0,_misc_js__rspack_import_0/* .assert */.vA)(codec !== null);
            if (_custom_coder_js__rspack_import_2/* .customAudioDecoders.some */.zx.some(x => x.supports(codec, decoderConfig))) {
                return true;
            }
    ...
    return {
        filter: queryA?.filter || queryB?.filter
            ? (track) => {
                ...
                if ((0,_misc_js__rspack_import_0/* .isThenable */.Qg)(resultA)) {
        ...
        sortBy: queryA?.sortBy || queryB?.sortBy
            ? (track) => {
                ...
                if ((0,_misc_js__rspack_import_0/* .isThenable */.Qg)(resultA) || (0,_misc_js__rspack_import_0/* .isThenable */.Qg)(resultB)) {
...
const queryInputTracks = async (tracks, query) => {
    ...
    if (query?.filter) {
        ...
        const hasAsyncFilter = filterMatches.some(x => (0,_misc_js__rspack_import_0/* .isThenable */.Qg)(x));
        if (hasAsyncFilter) {
    ...
    const hasAsyncSort = sortValues.some(x => (0,_misc_js__rspack_import_0/* .isThenable */.Qg)(x));
...
const simplestFractionBetween = (lo, hi, maxDenominator) => {
    for (let den = 1; den <= maxDenominator; den++) {
        ...
        if (num / den < hi) {
            return (0,_misc_js__rspack_import_0/* .simplifyRational */.Yf)({ num, den });
        }
    }
    return null;
};
...
2030(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Ng: () => (ENCRYPTION_KEY_CACHE_GROUP),
  QO: () => (InputDisposedError),
  pd: () => (Input)
});
/* import */ var _input_format_js__rspack_import_1 = __webpack_require__(5608);
/* import */ var _input_track_js__rspack_import_4 = __webpack_require__(6244);
/* import */ var _misc_js__rspack_import_0 = __webpack_require__(3912);
/* import */ var _reader_js__rspack_import_3 = __webpack_require__(7735);
/* import */ var _source_js__rspack_import_2 = __webpack_require__(4709);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
(0,_misc_js__rspack_import_0/* .polyfillSymbolDispose */.XQ)();
 ...
 * @public
 */
class Input extends _misc_js__rspack_import_0/* .EventEmitter */.bk {
    ...
    constructor(options) {
        ...
        if (!Array.isArray(options.formats) || options.formats.some(x => !(x instanceof _input_format_js__rspack_import_1/* .InputFormat */.CW))) {
            throw new TypeError('options.formats must be an array of InputFormat.');
        }
        if (!(options.source instanceof _source_js__rspack_import_2/* .Source */.kL || options.source instanceof _source_js__rspack_import_2/* .SourceRef */.Fy)) {
            throw new TypeError('options.source must be a Source or SourceRef.');
        }
        if (options.source instanceof _source_js__rspack_import_2/* .Source */.kL && options.source._disposed) {
        ...
        if (options.formatOptions !== undefined) {
            (0,_input_format_js__rspack_import_1/* .validateInputFormatOptions */.Gu)(options.formatOptions, 'formatOptions');
        }
        this._formats = options.formats;
        this._initInput = options.initInput ?? null;
        this._formatOptions = options.formatOptions ?? {};
        if (options.source instanceof _source_js__rspack_import_2/* .Source */.kL) {
    ...
    async _getSourceUncached(request) {
        (0,_misc_js__rspack_import_0/* .assert */.vA)(this._rootSource instanceof _source_js__rspack_import_2/* .PathedSource */.QI);
    ...
    _getSourceCached(request, cacheGroup = DEFAULT_SOURCE_CACHE_GROUP) {
        const cachedEntry = this._sourceCache.find(x => x.cacheGroup === cacheGroup && (0,_source_js__rspack_import_2/* .sourceRequestsAreEqual */.SM)(x.request, request));
        if (cachedEntry) {
            cachedEntry.age++;
            return Promise.resolve(cachedEntry.sourceRef.source.ref());
        }
        const cachedPromiseEntry = this._sourceCachePromises.find(x => x.cacheGroup === cacheGroup && (0,_source_js__rspack_import_2/* .sourceRequestsAreEqual */.SM)(x.request, request));
        ...
        const promise = (async () => {
            ...
            const count = (0,_misc_js__rspack_import_0/* .arrayCount */.v$)(this._sourceCache, x => x.cacheGroup === cacheGroup && x.sourceRef.source._refCount === 1);
            if (count >= MAX_SOURCE_CACHE_SIZE) {
                const minAgeIndex = (0,_misc_js__rspack_import_0/* .arrayArgmin */.Yg)(this._sourceCache, x => x.cacheGroup === cacheGroup && x.sourceRef.source._refCount === 1 ? x.age : Infinity);
                (0,_misc_js__rspack_import_0/* .assert */.vA)(minAgeIndex !== -1);
                const entry = this._sourceCache[minAgeIndex];
                this._sourceCache.splice(minAgeIndex, 1);
                entry.sourceRef.free();
                (0,_misc_js__rspack_import_0/* .removeItem */.Ai)(this._sourceRefs, entry.sourceRef);
            }
            this._sourceRefs.push(sourceRef);
            const promiseIndex = this._sourceCachePromises.findIndex(x => x.request === request);
            (0,_misc_js__rspack_import_0/* .assert */.vA)(promiseIndex !== -1);
    ...
    _getDemuxer() {
        return this._demuxerPromise ??= (async () => {
            this._reader = new _reader_js__rspack_import_3/* .Reader */.mP(this._rootSource);
    ...
    async getFormat() {
        ...
        (0,_misc_js__rspack_import_0/* .assert */.vA)(this._format);
        return this._format;
    }
    ...
    async getTracks(query) {
        query &&= (0,_input_track_js__rspack_import_4/* .toValidatedInputTrackQuery */.vo)(query);
        const backings = await this._getTrackBackings();
        const tracks = backings.map(backing => this._wrapBackingAsTrack(backing));
        return (0,_input_track_js__rspack_import_4/* .queryInputTracks */.NY)(tracks, query);
    }
    ...
    async getVideoTracks(query) {
        ...
        return (0,_input_track_js__rspack_import_4/* .queryInputTracks */.NY)(videoTracks, query);
    }
    ...
    async getAudioTracks(query) {
        ...
        return (0,_input_track_js__rspack_import_4/* .queryInputTracks */.NY)(audioTracks, query);
    }
    /**
    ...
    async getPrimaryVideoTrack(query) {
        query &&= (0,_input_track_js__rspack_import_4/* .toValidatedInputTrackQuery */.vo)(query);
        const merged = (0,_input_track_js__rspack_import_4/* .mergeInputTrackQueries */.Uj)(query, {
            sortBy: async (t) => [
                (0,_input_track_js__rspack_import_4/* .prefer */.D8)((await t.getDisposition()).default),
                (0,_input_track_js__rspack_import_4/* .prefer */.D8)(await t.hasPairableAudioTrack()),
                (0,_input_track_js__rspack_import_4/* .prefer */.D8)(!(await t.hasOnlyKeyPackets())),
                (0,_input_track_js__rspack_import_4/* .desc */.i8)(await t.getBitrate()),
            ],
        });
    ...
    async getPrimaryAudioTrack(query) {
        ...
        const merged = (0,_input_track_js__rspack_import_4/* .mergeInputTrackQueries */.Uj)(query, {
            sortBy: async (t) => [
                (0,_input_track_js__rspack_import_4/* .prefer */.D8)(!primaryVideoTrack || t.canBePairedWith(primaryVideoTrack)),
                (0,_input_track_js__rspack_import_4/* .prefer */.D8)((await t.getDisposition()).default),
                (0,_input_track_js__rspack_import_4/* .desc */.i8)(await t.getBitrate()),
            ],
        });
    ...
    _wrapBackingAsTrack(backing) {
        ...
        const track = type === 'video'
            ? new _input_track_js__rspack_import_4/* .InputVideoTrack */.N0(this, backing)
            : new _input_track_js__rspack_import_4/* .InputAudioTrack */.Yi(this, backing);
...
5996(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  T: () => (IsobmffDemuxer)
});
/* import */ var _shared_aac_misc_js__rspack_import_9 = __webpack_require__(1299);
/* import */ var _codec_js__rspack_import_5 = __webpack_require__(1188);
/* import */ var _codec_data_js__rspack_import_8 = __webpack_require__(6297);
/* import */ var _demuxer_js__rspack_import_0 = __webpack_require__(7202);
/* import */ var _misc_js__rspack_import_3 = __webpack_require__(3912);
/* import */ var _packet_js__rspack_import_12 = __webpack_require__(3936);
/* import */ var _isobmff_misc_js__rspack_import_1 = __webpack_require__(1826);
/* import */ var _isobmff_reader_js__rspack_import_2 = __webpack_require__(8561);
/* import */ var _reader_js__rspack_import_4 = __webpack_require__(7735);
/* import */ var _metadata_js__rspack_import_6 = __webpack_require__(5165);
/* import */ var _shared_ac3_misc_js__rspack_import_11 = __webpack_require__(7553);
/* import */ var _shared_bitstream_js__rspack_import_10 = __webpack_require__(1390);
/* import */ var _aes_js__rspack_import_13 = __webpack_require__(3373);
/* import */ var _logging_js__rspack_import_7 = __webpack_require__(6103);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class IsobmffDemuxer extends _demuxer_js__rspack_import_0/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.moovSlice = null;
    ...
    async getMimeType() {
        ...
        return (0,_isobmff_misc_js__rspack_import_1/* .buildIsobmffMimeType */.Xh)({
    ...
    readMetadata() {
        return this.metadataPromise ??= (async () => {
            ...
            while (true) {
                let slice = this.reader.requestSliceRange(currentPos, _isobmff_reader_js__rspack_import_2/* .MIN_BOX_HEADER_SIZE */.ZM, _isobmff_reader_js__rspack_import_2/* .MAX_BOX_HEADER_SIZE */.Xk);
                if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const startPos = currentPos;
                const boxInfo = (0,_isobmff_reader_js__rspack_import_2/* .readBoxHeader */.Vl)(slice);
                if (!boxInfo) {
                    break;
                }
                if (boxInfo.name === 'ftyp' || boxInfo.name === 'styp') {
                    const majorBrand = (0,_reader_js__rspack_import_4/* .readAscii */.IT)(slice, 4);
                    this.isQuickTime = majorBrand === 'qt  ';
                }
                else if (boxInfo.name === 'moov') {
                    // Found moov, load it
                    let moovSlice = this.reader.requestSlice(slice.filePos, boxInfo.contentSize);
                    if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(moovSlice))
            ...
            if (lookForMfraBox) {
                (0,_misc_js__rspack_import_3/* .assert */.vA)(this.reader.fileSize !== null);
                // The last 4 bytes may contain the size of the mfra box at the end of the file
                let lastWordSlice = this.reader.requestSlice(this.reader.fileSize - 4, 4);
                if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(lastWordSlice))
                    lastWordSlice = await lastWordSlice;
                (0,_misc_js__rspack_import_3/* .assert */.vA)(lastWordSlice);
                const lastWord = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(lastWordSlice);
                const potentialMfraPos = this.reader.fileSize - lastWord;
                if (potentialMfraPos >= 0 && potentialMfraPos <= this.reader.fileSize - _isobmff_reader_js__rspack_import_2/* .MAX_BOX_HEADER_SIZE */.Xk) {
                    let mfraHeaderSlice = this.reader.requestSliceRange(potentialMfraPos, _isobmff_reader_js__rspack_import_2/* .MIN_BOX_HEADER_SIZE */.ZM, _isobmff_reader_js__rspack_import_2/* .MAX_BOX_HEADER_SIZE */.Xk);
                    if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(mfraHeaderSlice))
                        mfraHeaderSlice = await mfraHeaderSlice;
                    if (mfraHeaderSlice) {
                        const boxInfo = (0,_isobmff_reader_js__rspack_import_2/* .readBoxHeader */.Vl)(mfraHeaderSlice);
                        if (boxInfo && boxInfo.name === 'mfra') {
                            ...
                            if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(mfraSlice))
    ...
    async copyMetadataFromInitInput(initInput) {
        ...
        for (const foreignTrack of initDemuxer.tracks) {
            ...
            if (foreignTrack.trackBacking) {
                (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info);
    ...
    getSampleTableForTrack(internalTrack) {
        ...
        (0,_misc_js__rspack_import_3/* .assert */.vA)(this.moovSlice);
        ...
        const isPcmCodec = internalTrack.info?.type === 'audio'
            ...
            && _codec_js__rspack_import_5/* .PCM_AUDIO_CODECS.includes */.Wq.includes(internalTrack.info.codec);
        if (isPcmCodec && sampleTable.sampleCompositionTimeOffsets.length === 0) {
            ...
            (0,_misc_js__rspack_import_3/* .assert */.vA)(internalTrack.info?.type === 'audio');
            const pcmInfo = (0,_codec_js__rspack_import_5/* .parsePcmCodec */.Ei)(internalTrack.info.codec);
            ...
            for (let i = 0; i < sampleTable.sampleToChunk.length; i++) {
                ...
                for (let j = 0; j < chunkCount; j++) {
                    ...
                    const startTimingEntryIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.sampleTimingEntries, startSampleIndex, x => x.startIndex);
                    const startTimingEntry = sampleTable.sampleTimingEntries[startTimingEntryIndex];
                    const endTimingEntryIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.sampleTimingEntries, endSampleIndex, x => x.startIndex);
                    ...
                    const lastSampleTimingEntry = (0,_misc_js__rspack_import_3/* .last */._g)(newSampleTimingEntries);
    ...
    async readFragment(startPos) {
        ...
        let headerSlice = this.reader.requestSliceRange(startPos, _isobmff_reader_js__rspack_import_2/* .MIN_BOX_HEADER_SIZE */.ZM, _isobmff_reader_js__rspack_import_2/* .MAX_BOX_HEADER_SIZE */.Xk);
        if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(headerSlice))
            headerSlice = await headerSlice;
        (0,_misc_js__rspack_import_3/* .assert */.vA)(headerSlice);
        const moofBoxInfo = (0,_isobmff_reader_js__rspack_import_2/* .readBoxHeader */.Vl)(headerSlice);
        (0,_misc_js__rspack_import_3/* .assert */.vA)(moofBoxInfo?.name === 'moof');
        let entireSlice = this.reader.requestSlice(startPos, moofBoxInfo.totalSize);
        if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(entireSlice))
            entireSlice = await entireSlice;
        (0,_misc_js__rspack_import_3/* .assert */.vA)(entireSlice);
        this.traverseBox(entireSlice);
        const fragment = this.lastReadFragment;
        (0,_misc_js__rspack_import_3/* .assert */.vA)(fragment && fragment.moofOffset === startPos);
        for (const [, trackData] of fragment.trackData) {
            ...
            if (!trackData.startTimestampIsFinal) {
                ...
                if (lookupEntry) {
                    ...
                    const lastCacheIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(fragmentPositionCache, fragment.moofOffset - 1, x => x.moofOffset);
                    if (lastCacheIndex !== -1) {
            ...
            // lookup table exists
            const insertionIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(fragmentPositionCache, trackData.startTimestamp, x => x.startTimestamp);
            if (insertionIndex === -1
    ...
    readContiguousBoxes(slice) {
        ...
        while (slice.filePos - startIndex <= slice.length - _isobmff_reader_js__rspack_import_2/* .MIN_BOX_HEADER_SIZE */.ZM) {
    ...
    *iterateContiguousBoxes(slice) {
    ...
    traverseBox(slice) {
        ...
        switch (boxInfo.name) {
            ...
            case 'mvhd':
                {
                    const version = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    slice.skip(3); // Flags
                    if (version === 1) {
                        slice.skip(8 + 8);
                        this.movieTimescale = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        this.movieDurationInTimescale = (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice);
                    }
                    else {
                        slice.skip(4 + 4);
                        this.movieTimescale = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        this.movieDurationInTimescale = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                }
                ;
                break;
            case 'trak':
                {
                    const track = {
                        ...
                        trackBacking: null,
                        disposition: {
                            ..._metadata_js__rspack_import_6/* .DEFAULT_TRACK_DISPOSITION */.gM,
                            primary: false,
                        },
                        info: null,
                        timescale: -1,
                        ...
                        name: null,
                        languageCode: _misc_js__rspack_import_3/* .UNDETERMINED_LANGUAGE */.IR,
            ...
            case 'tkhd':
                {
                    ...
                    const version = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const flags = (0,_reader_js__rspack_import_4/* .readU24Be */.n2)(slice);
                    ...
                    if (version === 0) {
                        slice.skip(8);
                        track.id = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        slice.skip(4);
                        track.durationInMovieTimescale = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                    else if (version === 1) {
                        slice.skip(16);
                        track.id = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        slice.skip(4);
                        track.durationInMovieTimescale = (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice);
                    }
                    else {
                    ...
                    const matrix = [
                        (0,_isobmff_reader_js__rspack_import_2/* .readFixed_16_16 */.vX)(slice),
                        (0,_isobmff_reader_js__rspack_import_2/* .readFixed_16_16 */.vX)(slice),
                        (0,_isobmff_reader_js__rspack_import_2/* .readFixed_2_30 */.IS)(slice),
                        (0,_isobmff_reader_js__rspack_import_2/* .readFixed_16_16 */.vX)(slice),
                        (0,_isobmff_reader_js__rspack_import_2/* .readFixed_16_16 */.vX)(slice),
                        (0,_isobmff_reader_js__rspack_import_2/* .readFixed_2_30 */.IS)(slice),
                        (0,_isobmff_reader_js__rspack_import_2/* .readFixed_16_16 */.vX)(slice),
                    ...
                    const rotation = (0,_misc_js__rspack_import_3/* .normalizeRotation */.qT)((0,_misc_js__rspack_import_3/* .roundToMultiple */["in"])(extractRotationFromMatrix(matrix), 90));
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(rotation === 0 || rotation === 90 || rotation === 180 || rotation === 270);
            ...
            case 'elst':
                {
                    ...
                    const entryCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const segmentDuration = version === 1
                            ? (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice)
                            : (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        const mediaTime = version === 1
                            ? (0,_reader_js__rspack_import_4/* .readI64Be */.B5)(slice)
                            : (0,_reader_js__rspack_import_4/* .readI32Be */.Ar)(slice);
                        const mediaRate = (0,_isobmff_reader_js__rspack_import_2/* .readFixed_16_16 */.vX)(slice);
                        if (segmentDuration === 0) {
                            // Don't care
                            continue;
                        }
                        if (relevantEntryFound) {
                            _logging_js__rspack_import_7/* .Logging._warn */.y._warn('Unsupported edit list: multiple edits are not currently supported. Only using first edit.');
                            break;
                        }
                        if (mediaTime === -1) {
                        ...
                        if (mediaRate !== 1) {
                            _logging_js__rspack_import_7/* .Logging._warn */.y._warn('Unsupported edit list entry: media rate must be 1.');
                            break;
                        }
            ...
            case 'mdhd':
                {
                    ...
                    if (version === 0) {
                        slice.skip(8);
                        track.timescale = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        track.durationInMediaTimescale = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                    else if (version === 1) {
                        slice.skip(16);
                        track.timescale = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        track.durationInMediaTimescale = (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice);
                    }
                    let language = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                    if (language > 0) {
                        track.languageCode = '';
                        for (let i = 0; i < 3; i++) {
                        ...
                        if (!(0,_misc_js__rspack_import_3/* .isIso639Dash2LanguageCode */.Nu)(track.languageCode)) {
                            // Sometimes the bytes are garbage
                            track.languageCode = _misc_js__rspack_import_3/* .UNDETERMINED_LANGUAGE */.IR;
                        }
                    }
                }
                ;
            ...
            case 'hdlr':
                {
                    ...
                    const handlerType = (0,_reader_js__rspack_import_4/* .readAscii */.IT)(slice, 4);
                    if (handlerType === 'vide') {
                        track.info = {
                            type: 'video',
                            width: -1,
                            ...
                            colorSpace: { ..._misc_js__rspack_import_3/* .EMPTY_COLOR_SPACE */.jW },
                            avcType: null,
                            avcCodecInfo: null,
                            hevcCodecInfo: null,
                            vp9CodecInfo: null,
            ...
            case 'stsd':
                {
                    ...
                    const stsdVersion = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    slice.skip(3); // Flags
                    const entries = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < entries; i++) {
                        const sampleBoxStartPos = slice.filePos;
                        const sampleBoxInfo = (0,_isobmff_reader_js__rspack_import_2/* .readBoxHeader */.Vl)(slice);
                        if (!sampleBoxInfo) {
                            break;
                        }
                        ...
                        if (track.info.type === 'video') {
                            ...
                            track.info.width = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                            track.info.height = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                            ...
                            else if (_codec_js__rspack_import_5/* .PRORES_FOURCCS.includes */.Y2.includes(lowercaseBoxName)) {
                                track.info.codec = 'prores';
                                track.info.proresFormat = lowercaseBoxName;
                            }
                            else if (codecName === null) {
                                _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unknown encrypted video codec due to missing frma box.`);
                            }
                            else {
                                _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unsupported video codec (sample entry type '${sampleBoxInfo.name}').`);
                            }
                        }
                        else {
                            slice.skip(6 * 1 + 2);
                            const version = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                            slice.skip(3 * 2);
                            let channelCount = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                            let sampleSize = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                            slice.skip(2 * 2);
                            // Can't use fixed16_16 as that's signed
                            let sampleRate = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice) / 0x10000;
                            let lpcmFlags = null;
                            if (stsdVersion === 0 && version > 0) {
                                // Additional QuickTime fields
                                if (version === 1) {
                                    slice.skip(4);
                                    sampleSize = 8 * (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                                    slice.skip(2 * 4);
                                }
                                else if (version === 2) {
                                    slice.skip(4);
                                    sampleRate = (0,_reader_js__rspack_import_4/* .readF64Be */._3)(slice);
                                    channelCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                                    slice.skip(4); // Always 0x7f000000
                                    sampleSize = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                                    lpcmFlags = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                                    slice.skip(2 * 4);
                                }
                            }
                            ...
                            if (codecName === 'mp4a') {
                                ...
                                track.info.sampleRate = _codec_js__rspack_import_5/* .OPUS_SAMPLE_RATE */.yo; // Always the same
                            }
                            ...
                            else if (_codec_js__rspack_import_5/* .DTS_FOURCCS.includes */.Sf.includes(codecName)) {
                                ...
                                if (sampleSize === 8) {
                                    ...
                                    _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unsupported sample size ${sampleSize} for codec 'twos'.`);
                                ...
                                if (sampleSize === 8) {
                                    ...
                                    _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unsupported sample size ${sampleSize} for codec 'sowt'.`);
                                    track.info.codec = null;
                                }
                            }
                                ...
                                if (track.info.pcmLittleEndian) {
                                    if (pcmSampleSize === 16) {
                                        ...
                                        _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Invalid ipcm sample size ${pcmSampleSize}.`);
                                        track.info.codec = null;
                                    }
                                }
                                else {
                                ...
                                if (track.info.pcmLittleEndian) {
                                    if (pcmSampleSize === 32) {
                                        ...
                                        _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Invalid fpcm sample size ${pcmSampleSize}.`);
                                        track.info.codec = null;
                                    }
                                }
                                else {
                                ...
                                if (track.info.codec === null) {
                                    _logging_js__rspack_import_7/* .Logging._warn */.y._warn('Unsupported PCM format.');
                                }
                            }
                            else if (codecName === null) {
                                _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unknown encrypted audio codec due to missing frma box.`);
                            }
                            else {
                                _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unsupported audio codec (sample entry type '${sampleBoxInfo.name}').`);
                            }
                        }
            ...
            case 'frma':
                {
                    ...
                    const format = (0,_reader_js__rspack_import_4/* .readAscii */.IT)(slice, 4);
            ...
            case 'schm':
                {
                    ...
                    const schemeType = (0,_reader_js__rspack_import_4/* .readAscii */.IT)(slice, 4);
                    if (schemeType === 'cenc' || schemeType === 'cens' || schemeType === 'cbcs') {
                        ...
                        _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unsupported encryption scheme '${schemeType}'.`);
                    }
                }
                ;
                break;
            case 'tenc':
                {
                    ...
                    const patternByte = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    if (version > 0) {
                    ...
                    track.encryptionInfo.defaultIsProtected = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice) !== 0;
                    track.encryptionInfo.defaultPerSampleIvSize = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    track.encryptionInfo.defaultKid = (0,_misc_js__rspack_import_3/* .bytesToHexString */.Br)((0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, 16));
                    if (track.encryptionInfo.defaultIsProtected && track.encryptionInfo.defaultPerSampleIvSize === 0) {
                        const constantIvSize = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                        const constantIv = new Uint8Array(16);
                        constantIv.set((0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, constantIvSize), 0);
            ...
            case 'avcC':
                {
                    ...
                    track.info.codecDescription = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, boxInfo.contentSize);
                }
                ;
                break;
            case 'hvcC':
            ...
            case 'vpcC':
                {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'video');
                    slice.skip(4); // Version + flags
                    const profile = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const level = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const thirdByte = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const bitDepth = thirdByte >> 4;
                    const chromaSubsampling = (thirdByte >> 1) & 0b111;
                    const videoFullRangeFlag = thirdByte & 1;
                    const colourPrimaries = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const transferCharacteristics = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const matrixCoefficients = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
            ...
            case 'av1C':
                {
                    ...
                    const secondByte = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    ...
                    const configObus = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, boxInfo.contentSize - 4);
                    const configObuInfo = (0,_codec_data_js__rspack_import_8/* .extractAv1CodecInfoFromPacket */.UU)(configObus);
            ...
            case 'colr':
                {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'video');
                    const colourType = (0,_reader_js__rspack_import_4/* .readAscii */.IT)(slice, 4);
                    if (colourType !== 'nclx' && colourType !== 'nclc') {
                        break;
                    }
                    const colourPrimaries = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                    const transferCharacteristics = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                    const matrixCoefficients = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                    let fullRange = undefined;
                    if (colourType === 'nclx') {
                        fullRange = Boolean((0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice) & 0x80);
                    }
                    track.info.colorSpace = {
                        primaries: _misc_js__rspack_import_3/* .COLOR_PRIMARIES_MAP_INVERSE */.BL[colourPrimaries],
                        transfer: _misc_js__rspack_import_3/* .TRANSFER_CHARACTERISTICS_MAP_INVERSE */.x_[transferCharacteristics],
                        matrix: _misc_js__rspack_import_3/* .MATRIX_COEFFICIENTS_MAP_INVERSE */.fl[matrixCoefficients],
                        fullRange,
                    };
                }
                ;
            ...
            case 'pasp':
                {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'video');
                    const num = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const den = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
            ...
            case 'esds':
                {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'audio');
                    slice.skip(4); // Version + flags
                    const tag = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(tag === 0x03); // ES Descriptor
                    (0,_isobmff_reader_js__rspack_import_2/* .readIsomVariableInteger */.hs)(slice); // Length
                    slice.skip(2); // ES ID
                    const mixed = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    ...
                    if (urlFlag) {
                        const urlLength = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                        slice.skip(urlLength);
                    }
                    if (ocrStreamFlag) {
                        slice.skip(2);
                    }
                    const decoderConfigTag = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(decoderConfigTag === 0x04); // DecoderConfigDescriptor
                    const decoderConfigDescriptorLength = (0,_isobmff_reader_js__rspack_import_2/* .readIsomVariableInteger */.hs)(slice); // Length
                    const payloadStart = slice.filePos;
                    const objectTypeIndication = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    if (objectTypeIndication === 0x40 || objectTypeIndication === 0x67) {
                        ...
                        _logging_js__rspack_import_7/* .Logging._warn */.y._warn(`Unsupported audio codec (objectTypeIndication ${objectTypeIndication}) - discarding track.`);
                    }
                    slice.skip(1 + 3 + 4 + 4);
                    if (decoderConfigDescriptorLength > slice.filePos - payloadStart) {
                        // There's a DecoderSpecificInfo at the end, let's read it
                        const decoderSpecificInfoTag = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                        (0,_misc_js__rspack_import_3/* .assert */.vA)(decoderSpecificInfoTag === 0x05); // DecoderSpecificInfo
                        const decoderSpecificInfoLength = (0,_isobmff_reader_js__rspack_import_2/* .readIsomVariableInteger */.hs)(slice);
                        track.info.codecDescription = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, decoderSpecificInfoLength);
                        if (track.info.codec === 'aac') {
                            // Let's try to deduce more accurate values directly from the AudioSpecificConfig:
                            const audioSpecificConfig = (0,_shared_aac_misc_js__rspack_import_9/* .parseAacAudioSpecificConfig */.zF)(track.info.codecDescription);
            ...
            case 'enda':
                {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'audio');
                    track.info.pcmLittleEndian = !!((0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice) & 0xff); // 0xff is from FFmpeg
                }
                ;
                break;
            case 'pcmC':
                {
                    ...
                    // ISO/IEC 23003-5
                    const formatFlags = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    track.info.pcmLittleEndian = Boolean(formatFlags & 0x01);
                    track.info.pcmSampleSize = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                }
                ;
                break;
            case 'dOps':
                { // Used for Opus audio
                    ...
                    const outputChannelCount = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const preSkip = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                    const inputSampleRate = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const outputGain = (0,_reader_js__rspack_import_4/* .readI16Be */.iH)(slice);
                    const channelMappingFamily = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    let channelMappingTable;
                    if (channelMappingFamily !== 0) {
                        channelMappingTable = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, 2 + outputChannelCount);
                    }
                    else {
            ...
            case 'dfLa':
                { // Used for FLAC audio
                    ...
                    while (slice.filePos < boxEndPos) {
                        const flagAndType = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                        const metadataBlockLength = (0,_reader_js__rspack_import_4/* .readU24Be */.n2)(slice);
                        const type = flagAndType & BLOCK_TYPE_MASK;
                        // It's a STREAMINFO block; let's extract the actual sample rate and channel count
                        if (type === _codec_data_js__rspack_import_8/* .FlacBlockType.STREAMINFO */.A3.STREAMINFO) {
                            slice.skip(10);
                            // Extract sample rate and channel count
                            const word = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    ...
                    const bytes = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, endPos - startPos);
            ...
            case 'dac3':
                { // AC3SpecificBox
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'audio');
                    const bytes = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, 3);
                    const bitstream = new _shared_bitstream_js__rspack_import_10/* .Bitstream */._(bytes);
                    ...
                    if (fscod < 3) {
                        track.info.sampleRate = _shared_ac3_misc_js__rspack_import_11/* .AC3_SAMPLE_RATES */.N[fscod];
                    }
                    track.info.numberOfChannels = _codec_data_js__rspack_import_8/* .AC3_ACMOD_CHANNEL_COUNTS */.ux[acmod] + lfeon;
                }
                ;
                break;
            case 'dec3':
                { // EC3SpecificBox
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'audio');
                    const bytes = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, boxInfo.contentSize);
                    const config = (0,_codec_data_js__rspack_import_8/* .parseEac3Config */.Sd)(bytes);
                    if (!config) {
                        _logging_js__rspack_import_7/* .Logging._warn */.y._warn('Invalid dec3 box contents, ignoring.');
                        break;
                    }
                    const sampleRate = (0,_codec_data_js__rspack_import_8/* .getEac3SampleRate */.PK)(config);
                    if (sampleRate !== null) {
                        track.info.sampleRate = sampleRate;
                    }
                    track.info.numberOfChannels = (0,_codec_data_js__rspack_import_8/* .getEac3ChannelCount */.zV)(config);
                }
                ;
                break;
            case 'ddts':
                { // DTSSpecificBox
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.info?.type === 'audio');
                    const bytes = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, Math.min(boxInfo.contentSize, _codec_data_js__rspack_import_8/* .DTS_SPECIFIC_BOX_SIZE */.Xc));
                    const config = (0,_codec_data_js__rspack_import_8/* .parseDtsSpecificBox */.ix)(bytes);
                    if (!config) {
                        _logging_js__rspack_import_7/* .Logging._warn */.y._warn('Invalid ddts box contents, ignoring.');
                        break;
                    }
            ...
            case 'stts':
                {
                    ...
                    for (let i = 0; i < entryCount; i++) {
                        const sampleCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        const sampleDelta = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
            ...
            case 'ctts':
                {
                    ...
                    for (let i = 0; i < entryCount; i++) {
                        const sampleCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        const sampleOffset = (0,_reader_js__rspack_import_4/* .readI32Be */.Ar)(slice);
            ...
            case 'stsz':
                {
                    ...
                    slice.skip(4); // Version + flags
                    const sampleSize = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const sampleCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    if (sampleSize === 0) {
            ...
            case 'stz2':
                {
                    ...
                    const fieldSize = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice); // in bits
                    const sampleCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const bytes = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, Math.ceil(sampleCount * fieldSize / 8));
                    const bitstream = new _shared_bitstream_js__rspack_import_10/* .Bitstream */._(bytes);
                    for (let i = 0; i < sampleCount; i++) {
            ...
            case 'stss':
                {
                    ...
                    const entryCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const sampleIndex = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice) - 1; // Convert to 0-indexed
            ...
            case 'stsc':
                {
                    ...
                    const entryCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const startChunkIndex = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice) - 1; // Convert to 0-indexed
                        const samplesPerChunk = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        const sampleDescriptionIndex = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
            ...
            case 'stco':
                {
                    ...
                    const entryCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const chunkOffset = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
            ...
            case 'co64':
                {
                    ...
                    const entryCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const chunkOffset = (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice);
                        track.sampleTable.chunkOffsets.push(chunkOffset);
                    }
                }
                ;
            ...
            case 'mehd':
                {
                    const version = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    slice.skip(3); // Flags
                    const fragmentDuration = version === 1 ? (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice) : (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
            ...
            case 'trex':
                {
                    slice.skip(4); // Version + flags
                    const trackId = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const defaultSampleDescriptionIndex = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const defaultSampleDuration = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const defaultSampleSize = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    const defaultSampleFlags = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
            ...
            case 'tfra':
                {
                    ...
                    const functions = [_reader_js__rspack_import_4/* .readU8 */.eo, _reader_js__rspack_import_4/* .readU16Be */.mH, _reader_js__rspack_import_4/* .readU24Be */.n2, _reader_js__rspack_import_4/* .readU32Be */.cN];
                    const readTrafNum = functions[lengthSizeOfTrafNum];
                    const readTrunNum = functions[lengthSizeOfTrunNum];
                    const readSampleNum = functions[lengthSizeOfSampleNum];
                    const numberOfEntries = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < numberOfEntries; i++) {
                        const time = version === 1 ? (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice) : (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        const moofOffset = version === 1 ? (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice) : (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        readTrafNum(slice);
                        readTrunNum(slice);
                        readSampleNum(slice);
            ...
            case 'traf':
                {
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(this.currentFragment);
                    this.readContiguousBoxes(slice.slice(contentStartPos, boxInfo.contentSize));
                    ...
                    if (this.currentTrack) {
                        ...
                        cond: if (trackData) {
                            ...
                            const lastSample = trackData.samples[(0,_misc_js__rspack_import_3/* .last */._g)(trackData.presentationTimestamps).sampleIndex];
                            trackData.startTimestamp = firstSample.presentationTimestamp;
                            trackData.endTimestamp = lastSample.presentationTimestamp + lastSample.duration;
                            const { currentFragmentState } = this.currentTrack;
                            (0,_misc_js__rspack_import_3/* .assert */.vA)(currentFragmentState);
            ...
            case 'pssh':
                {
                    ...
                    const psshBox = (0,_isobmff_misc_js__rspack_import_1/* .parsePsshBoxContents */.j1)((0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, boxInfo.contentSize));
            ...
            case 'tfhd':
                {
                    ...
                    if (baseDataOffsetPresent) {
                        track.currentFragmentState.baseDataOffset = (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice);
                    }
                    else if (defaultBaseIsMoof) {
                        track.currentFragmentState.baseDataOffset = this.currentFragment.moofOffset;
                    }
                    if (sampleDescriptionIndexPresent) {
                        track.currentFragmentState.sampleDescriptionIndex = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                    if (defaultSampleDurationPresent) {
                        track.currentFragmentState.defaultSampleDuration = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                    if (defaultSampleSizePresent) {
                        track.currentFragmentState.defaultSampleSize = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                    if (defaultSampleFlagsPresent) {
                        track.currentFragmentState.defaultSampleFlags = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                    if (durationIsEmpty) {
            ...
            case 'tfdt':
                {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.currentFragmentState);
                    const version = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    slice.skip(3); // Flags
                    const baseMediaDecodeTime = version === 0 ? (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice) : (0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice);
            ...
            case 'trun':
                {
                    ...
                    if (dataOffsetPresent) {
                        dataOffset = (0,_reader_js__rspack_import_4/* .readI32Be */.Ar)(slice);
                    }
                    let firstSampleFlags = null;
                    if (firstSampleFlagsPresent) {
                        firstSampleFlags = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    }
                    let trackData;
                    ...
                    for (let i = 0; i < sampleCount; i++) {
                        ...
                        if (sampleDurationPresent) {
                            sampleDuration = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        }
                        else {
                            (0,_misc_js__rspack_import_3/* .assert */.vA)(track.currentFragmentState.defaultSampleDuration !== null);
                        ...
                        if (sampleSizePresent) {
                            ...
                            (0,_misc_js__rspack_import_3/* .assert */.vA)(track.currentFragmentState.defaultSampleSize !== null);
                            sampleSize = track.currentFragmentState.defaultSampleSize;
                        }
                        let sampleFlags;
                        if (sampleFlagsPresent) {
                            sampleFlags = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        }
                        else {
                            (0,_misc_js__rspack_import_3/* .assert */.vA)(track.currentFragmentState.defaultSampleFlags !== null);
                        ...
                        if (sampleCompositionTimeOffsetsPresent) {
                            if (version === 0) {
                                sampleCompositionTimeOffset = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                            }
                            else {
                                sampleCompositionTimeOffset = (0,_reader_js__rspack_import_4/* .readI32Be */.Ar)(slice);
                            }
                        }
            ...
            case 'saiz':
                {
                    ...
                    const flags = (0,_reader_js__rspack_import_4/* .readU24Be */.n2)(slice);
                    if (flags & 0x01) {
                        const auxInfoType = (0,_reader_js__rspack_import_4/* .readAscii */.IT)(slice, 4);
                        const auxInfoTypeParam = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        if (auxInfoType !== track.encryptionInfo.scheme || auxInfoTypeParam !== 0) {
                            // Not the encryption aux info
                            break;
                        }
                    }
                    const defaultSampleInfoSize = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    const sampleCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    let sampleSizes = null;
                    if (defaultSampleInfoSize === 0 && sampleCount > 0) {
                        sampleSizes = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, sampleCount);
                    }
            ...
            case 'saio':
                {
                    ...
                    if (entryCount > 1) {
                        _logging_js__rspack_import_7/* .Logging._warn */.y._warn('Multiple saio entries are not supported; using the first offset only.');
                    }
                    let offset = version === 0 ? (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice) : Number((0,_reader_js__rspack_import_4/* .readU64Be */.th)(slice));
            ...
            case 'senc':
                {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(ivSize !== null);
                    for (let i = 0; i < Math.min(sampleCount, trackData.samples.length); i++) {
                        ...
                        if (ivSize > 0) {
                            iv.set((0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, ivSize), 0);
                        }
                        else {
                        ...
                        let subsamples = null;
                        if (useSubsamples) {
                            const subsampleCount = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                            subsamples = [];
                            for (let j = 0; j < subsampleCount; j++) {
                                const clearLen = (0,_reader_js__rspack_import_4/* .readU16Be */.mH)(slice);
                                const protectedLen = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    ...
                    for (const { boxInfo, slice } of iterator) {
                        if (boxInfo.name !== 'meta' && !this.currentTrack) {
                            ...
                            if (boxInfo.name[0] === '©') {
                                ...
                                this.metadataTags.raw[boxInfo.name] ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                            }
                            else {
                                this.metadataTags.raw[boxInfo.name] ??= (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, boxInfo.contentSize);
                            }
                            slice.filePos = startPos;
                        }
                        switch (boxInfo.name) {
                            ...
                            case 'name':
                                {
                                    if (this.currentTrack) {
                                        this.currentTrack.name = _misc_js__rspack_import_3/* .textDecoder.decode */.su.decode((0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, boxInfo.contentSize));
                                    }
                                    else {
                                        this.metadataTags.title ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©des':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.description ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©ART':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.artist ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©alb':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.album ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case 'albr':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.albumArtist ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©gen':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.genre ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©day':
                                {
                                    if (!this.currentTrack) {
                                        const date = new Date((0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice));
                            ...
                            case '©cmt':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.comment ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©lyr':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.lyrics ??= (0,_isobmff_reader_js__rspack_import_2/* .readMetadataStringShort */.$L)(slice);
                                    }
                                }
                                ;
                                break;
            ...
            case 'keys':
                {
                    ...
                    const entryCount = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const keySize = (0,_reader_js__rspack_import_4/* .readU32Be */.cN)(slice);
                        slice.skip(4); // Key namespace
                        const keyName = _misc_js__rspack_import_3/* .textDecoder.decode */.su.decode((0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, keySize - 8));
            ...
            case 'ilst':
                {
                    ...
                    for (const { boxInfo, slice } of iterator) {
                        ...
                        const data = (0,_isobmff_reader_js__rspack_import_2/* .readDataBox */.Cp)(slice);
                        this.metadataTags.raw ??= {};
                        ...
                        switch (metadataKey) {
                            ...
                            case 'com.apple.quicktime.artwork':
                                {
                                    if (data instanceof _metadata_js__rspack_import_6/* .RichImageData */.sF) {
                                        this.metadataTags.images ??= [];
                                        this.metadataTags.images.push({
                                            data: data.data,
                                            kind: 'coverFront',
                            ...
                            case 'trkn':
                                {
                                    if (data instanceof Uint8Array && data.length >= 6) {
                                        const view = (0,_misc_js__rspack_import_3/* .toDataView */.Zc)(data);
...
class IsobmffTrackBacking {
    ...
    async getDurationFromMetadata() {
        ...
        (0,_misc_js__rspack_import_3/* .assert */.vA)(track.trackBacking);
    ...
    mapTimestampIntoTimescale(timestamp) {
        ...
        return (0,_misc_js__rspack_import_3/* .roundIfAlmostInteger */.aI)(timestamp * this.internalTrack.timescale) + this.internalTrack.editListOffset;
    }
    async getPacket(timestamp, options) {
        ...
        return this.performFragmentedLookup(null, (fragment) => {
            ...
            const index = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(trackData.presentationTimestamps, timestampInTimescale, x => x.presentationTimestamp);
    ...
    async getKeyPacket(timestamp, options) {
        ...
        return this.performFragmentedLookup(null, (fragment) => {
            ...
            const index = (0,_misc_js__rspack_import_3/* .findLastIndex */.Kl)(trackData.presentationTimestamps, (x) => {
        ...
        return this.performFragmentedLookup(locationInFragment.fragment, (fragment) => {
            if (fragment === locationInFragment.fragment) {
                ...
                if (trackData && trackData.firstKeyFrameTimestamp !== null) {
                    ...
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(keyFrameIndex !== -1); // There must be one
                    return {
    ...
    async fetchPacketForSampleIndex(sampleIndex, options) {
        ...
        let data;
        if (options.metadataOnly) {
            data = _packet_js__rspack_import_12/* .PLACEHOLDER_DATA */.T;
        }
        else {
            ...
            data = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, sampleInfo.sampleSize);
        ...
        const packet = new _packet_js__rspack_import_12/* .EncodedPacket */.Z(data, sampleInfo.isKeyFrame ? 'key' : 'delta', timestamp, duration, sampleIndex, sampleInfo.sampleSize);
    ...
    async fetchPacketInFragment(fragment, sampleIndex, options) {
        ...
        (0,_misc_js__rspack_import_3/* .assert */.vA)(fragmentSample);
        let data;
        if (options.metadataOnly) {
            data = _packet_js__rspack_import_12/* .PLACEHOLDER_DATA */.T;
        }
            ...
            data = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, fragmentSample.byteSize);
            if (this.internalTrack.encryptionInfo) {
        ...
        const packet = new _packet_js__rspack_import_12/* .EncodedPacket */.Z(data, fragmentSample.isKeyFrame ? 'key' : 'delta', timestamp, duration, fragment.moofOffset + sampleIndex, fragmentSample.byteSize);
    ...
    latestTimestamp, options) {
        ...
        const lookupEntryIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(this.internalTrack.fragmentLookupTable, searchTimestamp, x => x.timestamp);
        const lookupEntry = lookupEntryIndex !== -1
            ? this.internalTrack.fragmentLookupTable[lookupEntryIndex]
            : null;
        const positionCacheIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(this.internalTrack.fragmentPositionCache, searchTimestamp, x => x.startTimestamp);
        ...
        while (true) {
            ...
            // Load the header
            let slice = demuxer.reader.requestSliceRange(currentPos, _isobmff_reader_js__rspack_import_2/* .MIN_BOX_HEADER_SIZE */.ZM, _isobmff_reader_js__rspack_import_2/* .MAX_BOX_HEADER_SIZE */.Xk);
            if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(slice))
                slice = await slice;
            if (!slice)
                break;
        ...
        if (lookupEntry && (!bestFragment || bestFragment.moofOffset < lookupEntry.moofOffset)) {
            ...
            (0,_misc_js__rspack_import_3/* .assert */.vA)(!previousLookupEntry || previousLookupEntry.timestamp < lookupEntry.timestamp);
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'avc' && !this.internalTrack.info.codecDescription) {
                ...
                this.internalTrack.info.avcCodecInfo
                    = firstPacket && (0,_codec_data_js__rspack_import_8/* .extractAvcDecoderConfigurationRecord */.fH)(firstPacket.data);
            }
            else if (this.internalTrack.info.codec === 'hevc' && !this.internalTrack.info.codecDescription) {
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.hevcCodecInfo
                    = firstPacket && (0,_codec_data_js__rspack_import_8/* .extractHevcDecoderConfigurationRecord */.D5)(firstPacket.data);
            }
                ...
                && (!this.internalTrack.info.vp9CodecInfo
                    ...
                    || !(0,_codec_data_js__rspack_import_8/* .vp9CodecInfoHasColorInfo */.$m)(this.internalTrack.info.vp9CodecInfo))) {
                const firstPacket = await this.getFirstPacket({});
                const packetInfo = firstPacket && (0,_codec_data_js__rspack_import_8/* .extractVp9CodecInfoFromPacket */.bs)(firstPacket.data);
                if (packetInfo) {
                    this.internalTrack.info.vp9CodecInfo = {
                ...
                && (!this.internalTrack.info.av1CodecInfo
                    ...
                    || !(0,_codec_data_js__rspack_import_8/* .av1CodecInfoHasColorInfo */.et)(this.internalTrack.info.av1CodecInfo))) {
                const firstPacket = await this.getFirstPacket({});
                const packetInfo = firstPacket && (0,_codec_data_js__rspack_import_8/* .extractAv1CodecInfoFromPacket */.UU)(firstPacket.data);
                if (packetInfo) {
                ...
                this.internalTrack.info.proresCodecInfo
                    = firstPacket && (0,_codec_data_js__rspack_import_8/* .extractProresCodecInfoFromPacket */.RU)(firstPacket.data);
            }
            if (!(0,_misc_js__rspack_import_3/* .colorSpaceIsComplete */.HV)(this.internalTrack.info.colorSpace)) {
                const colorSpace = (0,_codec_js__rspack_import_5/* .extractColorSpace */.LD)(this.internalTrack.info);
            ...
            const config = {
                codec: (0,_codec_js__rspack_import_5/* .extractVideoCodecString */.QP)(this.internalTrack.info),
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'dts' && !this.internalTrack.info.dtsFormat) {
                ...
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.dtsFormat = firstPacket && (0,_codec_data_js__rspack_import_8/* .extractDtsFourCcFromPacket */.n$)(firstPacket.data);
            }
            return {
                codec: (0,_codec_js__rspack_import_5/* .extractAudioCodecString */.X0)(this.internalTrack.info),
...
const getSampleIndexForTimestamp = (sampleTable, timescaleUnits) => {
    if (sampleTable.presentationTimestamps) {
        const index = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.presentationTimestamps, timescaleUnits, x => x.presentationTimestamp);
        if (index === -1) {
            return -1;
        }
        ...
        const index = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.sampleTimingEntries, timescaleUnits, x => x.startDecodeTimestamp);
        if (index === -1) {
            return -1;
        }
...
const getKeyframeSampleIndexForTimestamp = (sampleTable, timescaleUnits) => {
    ...
    if (sampleTable.presentationTimestamps) {
        ...
        for (let i = index; i >= 0; i--) {
            ...
            const isKeyFrame = (0,_misc_js__rspack_import_3/* .binarySearchExact */.pl)(sampleTable.keySampleIndices, sampleIndex, x => x) !== -1;
            if (isKeyFrame) {
                return sampleIndex;
            }
        }
        ...
        const index = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.keySampleIndices, sampleIndex, x => x);
        return sampleTable.keySampleIndices[index] ?? -1;
    }
};
const getSampleInfo = (sampleTable, sampleIndex) => {
    const timingEntryIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.sampleTimingEntries, sampleIndex, x => x.startIndex);
    ...
    const offsetEntryIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.sampleCompositionTimeOffsets, sampleIndex, x => x.startIndex);
    const offsetEntry = sampleTable.sampleCompositionTimeOffsets[offsetEntryIndex];
    if (offsetEntry && sampleIndex - offsetEntry.startIndex < offsetEntry.count) {
        presentationTimestamp += offsetEntry.offset;
    }
    const sampleSize = sampleTable.sampleSizes[Math.min(sampleIndex, sampleTable.sampleSizes.length - 1)];
    const chunkEntryIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(sampleTable.sampleToChunk, sampleIndex, x => x.startSampleIndex);
    const chunkEntry = sampleTable.sampleToChunk[chunkEntryIndex];
    (0,_misc_js__rspack_import_3/* .assert */.vA)(chunkEntry);
    ...
    if (sampleTable.presentationTimestamps) {
        ...
        (0,_misc_js__rspack_import_3/* .assert */.vA)(presentationIndex !== undefined);
    ...
    return {
        ...
        isKeyFrame: sampleTable.keySampleIndices
            ? (0,_misc_js__rspack_import_3/* .binarySearchExact */.pl)(sampleTable.keySampleIndices, sampleIndex, x => x) !== -1
            : true,
    };
};
...
const resolveEncryptionAuxInfo = async (reader, encryptionInfo, aux) => {
    ...
    if (aux.defaultSampleInfoSize > 0) {
        ...
        (0,_misc_js__rspack_import_3/* .assert */.vA)(aux.sampleSizes);
...
const decryptSample = async (track, sampleEncryption, data, fragment) => {
    (0,_misc_js__rspack_import_3/* .assert */.vA)(track.encryptionInfo);
    const encryptionInfo = track.encryptionInfo;
    (0,_misc_js__rspack_import_3/* .assert */.vA)(encryptionInfo.defaultKid !== null);
    ...
    if (cacheEntry) {
        ...
        const promise = (async () => {
            ...
            if (fragment) {
                ...
                for (let i = 0; i < psshBoxes.length - 1; i++) {
                    for (let j = i + 1; j < psshBoxes.length; j++) {
                        if ((0,_isobmff_misc_js__rspack_import_1/* .psshBoxesAreEqual */.MG)(psshBoxes[i], psshBoxes[j])) {
            ...
            if (!((typeof keyResult === 'string' && keyResult.length === 32 && _misc_js__rspack_import_3/* .HEX_STRING_REGEX.test */.Sn.test(keyResult))
            ...
            return keyResult instanceof Uint8Array
                ? keyResult
                : (0,_misc_js__rspack_import_3/* .hexStringToBytes */.ZY)(keyResult);
        })();
...
const decryptCtr = async (key, encryptionInfo, sampleEncryption, data) => {
    ...
    (0,_misc_js__rspack_import_3/* .assert */.vA)(encryptionInfo.defaultCryptByteBlock !== null && encryptionInfo.defaultSkipByteBlock !== null);
...
const decryptCbcs = (key, encryptionInfo, sampleEncryption, data) => {
    const ctx = new _aes_js__rspack_import_13/* .Aes128CbcContext */.UP();
    ...
    (0,_misc_js__rspack_import_3/* .assert */.vA)(cryptByteBlock !== null && skipByteBlock !== null);
    if (!sampleEncryption.subsamples) {
...
1826(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  MG: () => (psshBoxesAreEqual),
  Xh: () => (buildIsobmffMimeType),
  j1: () => (parsePsshBoxContents)
});
/* import */ var _misc_js__rspack_import_0 = __webpack_require__(3912);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
...
const parsePsshBoxContents = (contents) => {
    const view = (0,_misc_js__rspack_import_0/* .toDataView */.Zc)(contents);
    let pos = 0;
    const version = view.getUint8(pos);
    pos += 1;
    pos += 3; // Flags
    const systemId = (0,_misc_js__rspack_import_0/* .bytesToHexString */.Br)(contents.subarray(pos, pos + 16));
    pos += 16;
    let keyIds = null;
    if (version > 0) {
        ...
        if (kidCount > 0) {
            ...
            for (let i = 0; i < kidCount; i++) {
                keyIds.push((0,_misc_js__rspack_import_0/* .bytesToHexString */.Br)(contents.subarray(pos, pos + 16)));
                pos += 16;
            }
        }
    }
...
const psshBoxesAreEqual = (a, b) => (a.systemId === b.systemId
    && (0,_misc_js__rspack_import_0/* .uint8ArraysAreEqual */.ju)(a.data, b.data));


},
8561(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  $L: () => (readMetadataStringShort),
  Cp: () => (readDataBox),
  IS: () => (readFixed_2_30),
  Vl: () => (readBoxHeader),
  Xk: () => (MAX_BOX_HEADER_SIZE),
  ZM: () => (MIN_BOX_HEADER_SIZE),
  hs: () => (readIsomVariableInteger),
  vX: () => (readFixed_16_16)
});
/* import */ var _metadata_js__rspack_import_2 = __webpack_require__(5165);
/* import */ var _misc_js__rspack_import_1 = __webpack_require__(3912);
/* import */ var _reader_js__rspack_import_0 = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
...
const readBoxHeader = (slice) => {
    let totalSize = (0,_reader_js__rspack_import_0/* .readU32Be */.cN)(slice);
    const name = (0,_reader_js__rspack_import_0/* .readAscii */.IT)(slice, 4);
    let headerSize = 8;
    const hasLargeSize = totalSize === 1;
    if (hasLargeSize) {
        totalSize = (0,_reader_js__rspack_import_0/* .readU64Be */.th)(slice);
        headerSize = 16;
    }
...
const readFixed_16_16 = (slice) => {
    return (0,_reader_js__rspack_import_0/* .readI32Be */.Ar)(slice) / 0x10000;
};
const readFixed_2_30 = (slice) => {
    return (0,_reader_js__rspack_import_0/* .readI32Be */.Ar)(slice) / 0x40000000;
};
const readIsomVariableInteger = (slice) => {
    let result = 0;
    for (let i = 0; i < 4; i++) {
        result <<= 7;
        const nextByte = (0,_reader_js__rspack_import_0/* .readU8 */.eo)(slice);
...
const readMetadataStringShort = (slice) => {
    let stringLength = (0,_reader_js__rspack_import_0/* .readU16Be */.mH)(slice);
    slice.skip(2); // Language
    stringLength = Math.min(stringLength, slice.remainingLength);
    return _misc_js__rspack_import_1/* .textDecoder.decode */.su.decode((0,_reader_js__rspack_import_0/* .readBytes */.io)(slice, stringLength));
};
const readDataBox = (slice) => {
    ...
    const typeIndicator = (0,_reader_js__rspack_import_0/* .readU32Be */.cN)(slice);
    slice.skip(4); // Locale indicator
    const data = (0,_reader_js__rspack_import_0/* .readBytes */.io)(slice, header.contentSize - 8);
    switch (typeIndicator) {
        case 1: return _misc_js__rspack_import_1/* .textDecoder.decode */.su.decode(data); // UTF-8
        case 2: return new TextDecoder('utf-16be').decode(data); // UTF-16-BE
        case 13: return new _metadata_js__rspack_import_2/* .RichImageData */.sF(data, 'image/jpeg');
        case 14: return new _metadata_js__rspack_import_2/* .RichImageData */.sF(data, 'image/png');
        case 27: return new _metadata_js__rspack_import_2/* .RichImageData */.sF(data, 'image/bmp');
        default: return data;
    }
};
...
6103(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  y: () => (Logging)
});
/* import */ var _misc_js__rspack_import_0 = __webpack_require__(3912);
...
class Logging {
    ...
    static get _emitter() {
        ...
        return Logging._emitterInstance ??= new _misc_js__rspack_import_0/* .EventEmitter */.bk();
    }
...
7738(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  N: () => (MatroskaDemuxer)
});
/* import */ var _codec_data_js__rspack_import_9 = __webpack_require__(6297);
/* import */ var _codec_js__rspack_import_7 = __webpack_require__(1188);
/* import */ var _demuxer_js__rspack_import_1 = __webpack_require__(7202);
/* import */ var _logging_js__rspack_import_6 = __webpack_require__(6103);
/* import */ var _metadata_js__rspack_import_5 = __webpack_require__(5165);
/* import */ var _misc_js__rspack_import_3 = __webpack_require__(3912);
/* import */ var _packet_js__rspack_import_8 = __webpack_require__(3936);
/* import */ var _ebml_js__rspack_import_0 = __webpack_require__(6411);
/* import */ var _matroska_misc_js__rspack_import_2 = __webpack_require__(3616);
/* import */ var _reader_js__rspack_import_4 = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
...
const METADATA_ELEMENTS = [
    { id: _ebml_js__rspack_import_0/* .EBMLId.SeekHead */.Cl.SeekHead, flag: 'seekHeadSeen' },
    { id: _ebml_js__rspack_import_0/* .EBMLId.Info */.Cl.Info, flag: 'infoSeen' },
    { id: _ebml_js__rspack_import_0/* .EBMLId.Tracks */.Cl.Tracks, flag: 'tracksSeen' },
    { id: _ebml_js__rspack_import_0/* .EBMLId.Cues */.Cl.Cues, flag: 'cuesSeen' },
];
const MAX_RESYNC_LENGTH = 10 * 2 ** 20; // 10 MiB
class MatroskaDemuxer extends _demuxer_js__rspack_import_1/* .Demuxer */.B {
    constructor(input) {
        super(input);
    ...
    async getMimeType() {
        ...
        const backings = await this.getTrackBackings();
        const codecStrings = await Promise.all(backings.map(x => x.getDecoderConfig().then(c => c?.codec ?? null)));
        return (0,_matroska_misc_js__rspack_import_2/* .buildMatroskaMimeType */.V)({
            isWebM: this.isWebM,
    ...
    readMetadata() {
        return this.readMetadataPromise ??= (async () => {
            ...
            while (true) {
                let slice = this.reader.requestSliceRange(currentPos, _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De, _ebml_js__rspack_import_0/* .MAX_HEADER_SIZE */.r1);
                if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const header = (0,_ebml_js__rspack_import_0/* .readElementHeader */.ur)(slice);
                if (!header) {
                ...
                if (id === _ebml_js__rspack_import_0/* .EBMLId.EBML */.Cl.EBML) {
                    (0,_ebml_js__rspack_import_0/* .assertDefinedSize */.p)(size);
                ...
                else if (id === _ebml_js__rspack_import_0/* .EBMLId.Segment */.Cl.Segment) { // Segment found!
                ...
                else if (id === _ebml_js__rspack_import_0/* .EBMLId.Cluster */.Cl.Cluster) {
                    if (this.reader.fileSize === null) {
                    ...
                    if (size === undefined) {
                        ...
                        // determine its size.
                        const nextElementPos = await (0,_ebml_js__rspack_import_0/* .searchForNextElementId */.IQ)(this.reader, dataStartPos, _ebml_js__rspack_import_0/* .LEVEL_0_AND_1_EBML_IDS */.K9, this.reader.fileSize);
                        size = nextElementPos.pos - dataStartPos;
                    }
                    const lastSegment = (0,_misc_js__rspack_import_3/* .last */._g)(this.segments);
                    if (lastSegment) {
    ...
    async readSegment(segmentDataStart, dataSize) {
        ...
        while (this.currentSegment.elementEndPos === null || currentPos < this.currentSegment.elementEndPos) {
            ...
            const header = (0,_ebml_js__rspack_import_0/* .readElementHeader */.ur)(slice);
            if (!header || (!_ebml_js__rspack_import_0/* .LEVEL_1_EBML_IDS.includes */.VE.includes(header.id) && header.id !== _ebml_js__rspack_import_0/* .EBMLId.Void */.Cl.Void)) {
                // Potential junk. Let's try to resync
                const nextPos = await (0,_ebml_js__rspack_import_0/* .resync */.nE)(this.reader, elementStartPos, _ebml_js__rspack_import_0/* .LEVEL_1_EBML_IDS */.VE, Math.min(this.currentSegment.elementEndPos ?? Infinity, elementStartPos + MAX_RESYNC_LENGTH));
                if (nextPos) {
                    currentPos = nextPos;
                    continue;
                }
            ...
            else if (id === _ebml_js__rspack_import_0/* .EBMLId.Tags */.Cl.Tags || id === _ebml_js__rspack_import_0/* .EBMLId.Attachments */.Cl.Attachments) {
                // Metadata found at the beginning of the segment, great, let's parse it
                if (id === _ebml_js__rspack_import_0/* .EBMLId.Tags */.Cl.Tags) {
        ...
        if (this.reader.fileSize !== null) {
            ...
            for (const seekEntry of this.currentSegment.seekEntries) {
                ...
                if (this.currentSegment[target.flag])
                    continue;
                let slice = this.reader.requestSliceRange(segmentDataStart + seekEntry.segmentPosition, _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De, _ebml_js__rspack_import_0/* .MAX_HEADER_SIZE */.r1);
                if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(slice))
                    slice = await slice;
                if (!slice)
                    continue;
                ...
                if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(dataSlice))
    ...
    async readCluster(startPos, segment) {
        ...
        let headerSlice = this.reader.requestSliceRange(startPos, _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De, _ebml_js__rspack_import_0/* .MAX_HEADER_SIZE */.r1);
        if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(headerSlice))
            headerSlice = await headerSlice;
        (0,_misc_js__rspack_import_3/* .assert */.vA)(headerSlice);
        const elementStartPos = startPos;
        const elementHeader = (0,_ebml_js__rspack_import_0/* .readElementHeader */.ur)(headerSlice);
        (0,_misc_js__rspack_import_3/* .assert */.vA)(elementHeader);
        const id = elementHeader.id;
        (0,_misc_js__rspack_import_3/* .assert */.vA)(id === _ebml_js__rspack_import_0/* .EBMLId.Cluster */.Cl.Cluster);
        ...
        if (size === undefined) {
            ...
            const nextElementPos = await (0,_ebml_js__rspack_import_0/* .searchForNextElementId */.IQ)(this.reader, dataStartPos, _ebml_js__rspack_import_0/* .LEVEL_0_AND_1_EBML_IDS */.K9, segment.elementEndPos);
            size = nextElementPos.pos - dataStartPos;
        }
        ...
        if (dataSlice) {
            ...
            const endPos = this.readContiguousElements(dataSlice, _ebml_js__rspack_import_0/* .LEVEL_0_AND_1_EBML_IDS */.K9);
        ...
        for (const [, trackData] of cluster.trackData) {
            ...
            (0,_misc_js__rspack_import_3/* .assert */.vA)(trackData.blocks.length > 0);
            ...
            const lastBlock = trackData.blocks[(0,_misc_js__rspack_import_3/* .last */._g)(trackData.presentationTimestamps).blockIndex];
            ...
            const insertionIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(track.clusterPositionCache, trackData.startTimestamp, x => x.startTimestamp);
            if (insertionIndex === -1
    ...
    expandLacedBlocks(blocks, track) {
        ...
        for (let blockIndex = 0; blockIndex < blocks.length; blockIndex++) {
            ...
            const slice = _reader_js__rspack_import_4/* .FileSlice.tempFromBytes */.x$.tempFromBytes(originalBlock.data);
            const frameSizes = [];
            const frameCount = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice) + 1;
                ...
                case BlockLacing.Xiph:
                    {
                        ...
                        for (let i = 0; i < frameCount - 1; i++) {
                            ...
                            while (slice.bufferPos < slice.length) {
                                const value = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                                frameSize += value;
                                if (value < 255) {
                ...
                case BlockLacing.Ebml:
                    {
                        ...
                        const firstResult = (0,_ebml_js__rspack_import_0/* .readVarInt */.pT)(slice);
                        (0,_misc_js__rspack_import_3/* .assert */.vA)(firstResult !== null); // Assume it's not an invalid VINT
                        let currentSize = firstResult;
                        frameSizes.push(currentSize);
                        let totalUsedSize = currentSize;
                        for (let i = 1; i < frameCount - 1; i++) {
                            const startPos = slice.bufferPos;
                            const diffResult = (0,_ebml_js__rspack_import_0/* .readVarInt */.pT)(slice);
                            (0,_misc_js__rspack_import_3/* .assert */.vA)(diffResult !== null);
                    ...
                    ;
                    break;
                default: (0,_misc_js__rspack_import_3/* .assert */.vA)(false);
            }
            (0,_misc_js__rspack_import_3/* .assert */.vA)(frameSizes.length === frameCount);
            blocks.splice(blockIndex, 1); // Remove the original block
            const blockDuration = originalBlock.duration || frameCount * (track.defaultDuration ?? 0);
            // Now, let's insert each frame as its own block
            for (let i = 0; i < frameCount; i++) {
                const frameSize = frameSizes[i];
                const frameData = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, frameSize);
    ...
    async loadSegmentMetadata(segment) {
        for (const seekEntry of segment.seekEntries) {
            if (seekEntry.id === _ebml_js__rspack_import_0/* .EBMLId.Tags */.Cl.Tags && !segment.tagsSeen) {
                // We need to load the tags
            }
            else if (seekEntry.id === _ebml_js__rspack_import_0/* .EBMLId.Attachments */.Cl.Attachments && !segment.attachmentsSeen) {
                // We need to load the attachments
            }
            else {
                continue;
            }
            let slice = this.reader.requestSliceRange(segment.dataStartPos + seekEntry.segmentPosition, _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De, _ebml_js__rspack_import_0/* .MAX_HEADER_SIZE */.r1);
            if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(slice))
                slice = await slice;
            if (!slice)
                continue;
            ...
            const { size } = header;
            (0,_ebml_js__rspack_import_0/* .assertDefinedSize */.p)(size);
            (0,_misc_js__rspack_import_3/* .assert */.vA)(!this.currentSegment);
            ...
            this.currentSegment = null;
            // Mark as seen
            if (seekEntry.id === _ebml_js__rspack_import_0/* .EBMLId.Tags */.Cl.Tags) {
                segment.tagsSeen = true;
            }
            else if (seekEntry.id === _ebml_js__rspack_import_0/* .EBMLId.Attachments */.Cl.Attachments) {
                segment.attachmentsSeen = true;
            }
        }
    }
    readContiguousElements(slice, stopIds) {
        while (slice.remainingLength >= _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De) {
            const startPos = slice.filePos;
    ...
    traverseElement(slice, stopIds) {
        ...
        (0,_ebml_js__rspack_import_0/* .assertDefinedSize */.p)(size);
        switch (id) {
            case _ebml_js__rspack_import_0/* .EBMLId.DocType */.Cl.DocType:
                {
                    this.isWebM = (0,_ebml_js__rspack_import_0/* .readAsciiString */.IX)(slice, size) === 'webm';
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Seek */.Cl.Seek:
                {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.SeekID */.Cl.SeekID:
                {
                    const lastSeekEntry = this.currentSegment?.seekEntries[this.currentSegment.seekEntries.length - 1];
                    if (!lastSeekEntry)
                        break;
                    lastSeekEntry.id = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.SeekPosition */.Cl.SeekPosition:
                {
                    const lastSeekEntry = this.currentSegment?.seekEntries[this.currentSegment.seekEntries.length - 1];
                    if (!lastSeekEntry)
                        break;
                    lastSeekEntry.segmentPosition = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TimestampScale */.Cl.TimestampScale:
                {
                    if (!this.currentSegment)
                        break;
                    this.currentSegment.timestampScale = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                    this.currentSegment.timestampFactor = 1e9 / this.currentSegment.timestampScale;
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Duration */.Cl.Duration:
                {
                    if (!this.currentSegment)
                        break;
                    this.currentSegment.duration = (0,_ebml_js__rspack_import_0/* .readFloat */.zH)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TrackEntry */.Cl.TrackEntry:
                {
                    if (!this.currentSegment)
                        break;
                    this.currentTrack = {
                    ...
                    if (this.currentTrack.decodingInstructions.some((instruction) => {
                        ...
                        _logging_js__rspack_import_6/* .Logging._warn */.y._warn(`Track #${this.currentTrack.id} has an unsupported content encoding; dropping.`);
                        this.currentTrack = null;
                    }
                    if (this.currentTrack
                        ...
                        if (this.currentTrack.info.type === 'video'
                            ...
                            if (this.currentTrack.codecId === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.avc */.oo.avc) {
                                this.currentTrack.info.codec = 'avc';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (this.currentTrack.codecId === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.hevc */.oo.hevc) {
                                this.currentTrack.info.codec = 'hevc';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.vp8 */.oo.vp8) {
                                this.currentTrack.info.codec = 'vp8';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.vp9 */.oo.vp9) {
                                this.currentTrack.info.codec = 'vp9';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.av1 */.oo.av1) {
                                this.currentTrack.info.codec = 'av1';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.prores */.oo.prores) {
                                const format = this.currentTrack.codecPrivate
                                    ? _misc_js__rspack_import_3/* .textDecoder.decode */.su.decode(this.currentTrack.codecPrivate)
                                    : '';
                                if (_codec_js__rspack_import_7/* .PRORES_FOURCCS.includes */.Y2.includes(format)) {
                            ...
                            if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.aac */.oo.aac) {
                            ...
                            else if (this.currentTrack.codecId === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.mp3 */.oo.mp3) {
                                this.currentTrack.info.codec = 'mp3';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.opus */.oo.opus) {
                                this.currentTrack.info.codec = 'opus';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                                this.currentTrack.info.sampleRate = _codec_js__rspack_import_7/* .OPUS_SAMPLE_RATE */.yo; // Always the same
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.vorbis */.oo.vorbis) {
                                this.currentTrack.info.codec = 'vorbis';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.flac */.oo.flac) {
                                this.currentTrack.info.codec = 'flac';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.ac3 */.oo.ac3) {
                                this.currentTrack.info.codec = 'ac3';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.eac3 */.oo.eac3) {
                                this.currentTrack.info.codec = 'eac3';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__rspack_import_0/* .CODEC_STRING_MAP.dts */.oo.dts) {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TrackNumber */.Cl.TrackNumber:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.id = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TrackType */.Cl.TrackType:
                {
                    if (!this.currentTrack)
                        break;
                    const type = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                    if (type === 1) {
                        this.currentTrack.info = {
                            type: 'video',
                            width: -1,
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FlagEnabled */.Cl.FlagEnabled:
                {
                    if (!this.currentTrack)
                        break;
                    const enabled = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                    if (!enabled) {
                        this.currentTrack = null;
                    }
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FlagDefault */.Cl.FlagDefault:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.default = !!(0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FlagForced */.Cl.FlagForced:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.forced = !!(0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FlagOriginal */.Cl.FlagOriginal:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.original = !!(0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FlagHearingImpaired */.Cl.FlagHearingImpaired:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.hearingImpaired = !!(0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FlagVisualImpaired */.Cl.FlagVisualImpaired:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.visuallyImpaired = !!(0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FlagCommentary */.Cl.FlagCommentary:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.commentary = !!(0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.CodecID */.Cl.CodecID:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.codecId = (0,_ebml_js__rspack_import_0/* .readAsciiString */.IX)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.CodecPrivate */.Cl.CodecPrivate:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.codecPrivate = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.DefaultDuration */.Cl.DefaultDuration:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.defaultDurationNs = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Name */.Cl.Name:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.name = (0,_ebml_js__rspack_import_0/* .readUnicodeString */.jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Language */.Cl.Language:
                {
                    if (!this.currentTrack)
                        break;
                    ...
                    this.currentTrack.languageCode = (0,_ebml_js__rspack_import_0/* .readAsciiString */.IX)(slice, size);
                    if (!(0,_misc_js__rspack_import_3/* .isIso639Dash2LanguageCode */.Nu)(this.currentTrack.languageCode)) {
                        this.currentTrack.languageCode = _misc_js__rspack_import_3/* .UNDETERMINED_LANGUAGE */.IR;
                    }
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.LanguageBCP47 */.Cl.LanguageBCP47:
                {
                    if (!this.currentTrack)
                        break;
                    const bcp47 = (0,_ebml_js__rspack_import_0/* .readAsciiString */.IX)(slice, size);
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Video */.Cl.Video:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.PixelWidth */.Cl.PixelWidth:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.width = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.PixelHeight */.Cl.PixelHeight:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.height = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.DisplayWidth */.Cl.DisplayWidth:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.displayWidth = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.DisplayHeight */.Cl.DisplayHeight:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.displayHeight = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.DisplayUnit */.Cl.DisplayUnit:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.displayUnit = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.AlphaMode */.Cl.AlphaMode:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.alphaMode = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size) === 1;
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Colour */.Cl.Colour:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.MatrixCoefficients */.Cl.MatrixCoefficients:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const matrixCoefficients = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                    const mapped = _misc_js__rspack_import_3/* .MATRIX_COEFFICIENTS_MAP_INVERSE */.fl[matrixCoefficients];
                    this.currentTrack.info.colorSpace.matrix = mapped;
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Range */.Cl.Range:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const range = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TransferCharacteristics */.Cl.TransferCharacteristics:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const transferCharacteristics = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                    const mapped = _misc_js__rspack_import_3/* .TRANSFER_CHARACTERISTICS_MAP_INVERSE */.x_[transferCharacteristics];
                    this.currentTrack.info.colorSpace.transfer = mapped;
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Primaries */.Cl.Primaries:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const primaries = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                    const mapped = _misc_js__rspack_import_3/* .COLOR_PRIMARIES_MAP_INVERSE */.BL[primaries];
                    this.currentTrack.info.colorSpace.primaries = mapped;
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Projection */.Cl.Projection:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ProjectionPoseRoll */.Cl.ProjectionPoseRoll:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const rotation = (0,_ebml_js__rspack_import_0/* .readFloat */.zH)(slice, size);
                    const flippedRotation = -rotation; // Convert counter-clockwise to clockwise
                    try {
                        this.currentTrack.info.rotation = (0,_misc_js__rspack_import_3/* .normalizeRotation */.qT)(flippedRotation);
                    }
                    catch {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Audio */.Cl.Audio:
                {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.SamplingFrequency */.Cl.SamplingFrequency:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                    this.currentTrack.info.sampleRate = (0,_ebml_js__rspack_import_0/* .readFloat */.zH)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Channels */.Cl.Channels:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                    this.currentTrack.info.numberOfChannels = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.BitDepth */.Cl.BitDepth:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                    this.currentTrack.info.bitDepth = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.CuePoint */.Cl.CuePoint:
                {
                    if (!this.currentSegment)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.CueTime */.Cl.CueTime:
                {
                    this.currentCueTime = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.CueTrackPositions */.Cl.CueTrackPositions:
                {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.CueTrack */.Cl.CueTrack:
                {
                    const lastCuePoint = this.currentSegment?.cuePoints[this.currentSegment.cuePoints.length - 1];
                    if (!lastCuePoint)
                        break;
                    lastCuePoint.trackId = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.CueClusterPosition */.Cl.CueClusterPosition:
                {
                    const lastCuePoint = this.currentSegment?.cuePoints[this.currentSegment.cuePoints.length - 1];
                    if (!lastCuePoint)
                        break;
                    (0,_misc_js__rspack_import_3/* .assert */.vA)(this.currentSegment);
                    lastCuePoint.clusterPosition = this.currentSegment.dataStartPos + (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Timestamp */.Cl.Timestamp:
                {
                    if (!this.currentCluster)
                        break;
                    this.currentCluster.timestamp = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.SimpleBlock */.Cl.SimpleBlock:
                {
                    if (!this.currentCluster)
                        break;
                    const trackNumber = (0,_ebml_js__rspack_import_0/* .readVarInt */.pT)(slice);
                    if (trackNumber === null)
                        break;
                    const trackData = this.getTrackDataInCluster(this.currentCluster, trackNumber);
                    if (!trackData)
                        break; // Not a track we care about
                    const relativeTimestamp = (0,_reader_js__rspack_import_4/* .readI16Be */.iH)(slice);
                    const flags = (0,_reader_js__rspack_import_4/* .readU8 */.eo)(slice);
                    ...
                    const blockData = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, size - (slice.filePos - dataStartPos));
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.BlockGroup */.Cl.BlockGroup:
                {
                    if (!this.currentCluster)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Block */.Cl.Block:
                {
                    if (!this.currentCluster)
                        break;
                    const trackNumber = (0,_ebml_js__rspack_import_0/* .readVarInt */.pT)(slice);
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.BlockAdditions */.Cl.BlockAdditions:
                {
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.BlockMore */.Cl.BlockMore:
                {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.BlockAdditional */.Cl.BlockAdditional:
                {
                    if (!this.currentBlockAdditional)
                        break;
                    this.currentBlockAdditional.data = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.BlockAddID */.Cl.BlockAddID:
                {
                    if (!this.currentBlockAdditional)
                        break;
                    this.currentBlockAdditional.addId = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.BlockDuration */.Cl.BlockDuration:
                {
                    if (!this.currentBlock)
                        break;
                    this.currentBlock.duration = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ReferenceBlock */.Cl.ReferenceBlock:
                {
                    if (!this.currentBlock)
                        break;
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Tag */.Cl.Tag:
                {
                    this.currentTagTargetIsMovie = true;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.Targets */.Cl.Targets:
                {
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TargetTypeValue */.Cl.TargetTypeValue:
                {
                    const targetTypeValue = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TagTrackUID */.Cl.TagTrackUID:
            case _ebml_js__rspack_import_0/* .EBMLId.TagEditionUID */.Cl.TagEditionUID:
            case _ebml_js__rspack_import_0/* .EBMLId.TagChapterUID */.Cl.TagChapterUID:
            case _ebml_js__rspack_import_0/* .EBMLId.TagAttachmentUID */.Cl.TagAttachmentUID:
                {
                    this.currentTagTargetIsMovie = false;
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.SimpleTag */.Cl.SimpleTag:
                {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TagName */.Cl.TagName:
                {
                    this.currentSimpleTagName = (0,_ebml_js__rspack_import_0/* .readUnicodeString */.jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TagString */.Cl.TagString:
                {
                    if (!this.currentSimpleTagName)
                        break;
                    const value = (0,_ebml_js__rspack_import_0/* .readUnicodeString */.jR)(slice, size);
                    this.processTagValue(this.currentSimpleTagName, value);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.TagBinary */.Cl.TagBinary:
                {
                    if (!this.currentSimpleTagName)
                        break;
                    const value = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, size);
                    this.processTagValue(this.currentSimpleTagName, value);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.AttachedFile */.Cl.AttachedFile:
                {
                    if (!this.currentSegment)
                        break;
                    ...
                    if (this.currentAttachedFile.fileUid && this.currentAttachedFile.fileData) {
                        ...
                        tags.raw ??= {};
                        tags.raw[this.currentAttachedFile.fileUid.toString()] = new _metadata_js__rspack_import_5/* .AttachedFile */.VF(this.currentAttachedFile.fileData, this.currentAttachedFile.fileMediaType ?? undefined, this.currentAttachedFile.fileName ?? undefined, this.currentAttachedFile.fileDescription ?? undefined);
                    }
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FileUID */.Cl.FileUID:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileUid = (0,_ebml_js__rspack_import_0/* .readUnsignedBigInt */.Ry)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FileName */.Cl.FileName:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileName = (0,_ebml_js__rspack_import_0/* .readUnicodeString */.jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FileMediaType */.Cl.FileMediaType:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileMediaType = (0,_ebml_js__rspack_import_0/* .readAsciiString */.IX)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FileData */.Cl.FileData:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileData = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.FileDescription */.Cl.FileDescription:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileDescription = (0,_ebml_js__rspack_import_0/* .readUnicodeString */.jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentEncodings */.Cl.ContentEncodings:
                {
                    if (!this.currentTrack)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentEncoding */.Cl.ContentEncoding:
                {
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentEncodingOrder */.Cl.ContentEncodingOrder:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.order = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentEncodingScope */.Cl.ContentEncodingScope:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.scope = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentCompression */.Cl.ContentCompression:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                ...
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentCompAlgo */.Cl.ContentCompAlgo:
                {
                    if (this.currentDecodingInstruction?.data?.type !== 'decompress')
                        break;
                    this.currentDecodingInstruction.data.algorithm = (0,_ebml_js__rspack_import_0/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentCompSettings */.Cl.ContentCompSettings:
                {
                    if (this.currentDecodingInstruction?.data?.type !== 'decompress')
                        break;
                    this.currentDecodingInstruction.data.settings = (0,_reader_js__rspack_import_4/* .readBytes */.io)(slice, size);
                }
                ;
                break;
            case _ebml_js__rspack_import_0/* .EBMLId.ContentEncryption */.Cl.ContentEncryption:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.data = {
    ...
    decodeBlockData(track, rawData) {
        (0,_misc_js__rspack_import_3/* .assert */.vA)(track.decodingInstructions.length > 0); // This method shouldn't be called otherwise
        let currentData = rawData;
        for (const instruction of track.decodingInstructions) {
            (0,_misc_js__rspack_import_3/* .assert */.vA)(instruction.data);
...
class MatroskaTrackBacking {
    ...
    intoTimescale(timestamp) {
        ...
        // that the number was originally an integer divided by the timescale. For stability, it's best
        // to return the integer in this case.
        return (0,_misc_js__rspack_import_3/* .roundIfAlmostInteger */.aI)(timestamp * this.internalTrack.segment.timestampFactor);
    }
    async getPacket(timestamp, options) {
        ...
        return this.performClusterLookup(null, (cluster) => {
            ...
            const index = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(trackData.presentationTimestamps, timestampInTimescale, x => x.timestamp);
    ...
    async fetchPacketInCluster(cluster, blockIndex, options) {
        ...
        (0,_misc_js__rspack_import_3/* .assert */.vA)(block);
        ...
        if (!block.postProcessed) {
            if (this.internalTrack.info?.codec === 'prores') {
                ...
                if (!hasFrameContainer) {
                    ...
                    const newDataView = (0,_misc_js__rspack_import_3/* .toDataView */.Zc)(newData);
        ...
        const data = options.metadataOnly ? _packet_js__rspack_import_8/* .PLACEHOLDER_DATA */.T : block.data;
        const timestamp = block.timestamp / this.internalTrack.segment.timestampFactor;
        const duration = block.duration / this.internalTrack.segment.timestampFactor;
        const sideData = {};
        if (block.mainAdditional && this.internalTrack.info?.type === 'video' && this.internalTrack.info.alphaMode) {
            sideData.alpha = options.metadataOnly ? _packet_js__rspack_import_8/* .PLACEHOLDER_DATA */.T : block.mainAdditional;
            sideData.alphaByteLength = block.mainAdditional.byteLength;
        }
        const packet = new _packet_js__rspack_import_8/* .EncodedPacket */.Z(data, block.isKeyFrame ? 'key' : 'delta', timestamp, duration, cluster.dataStartPos + blockIndex, block.data.byteLength, sideData);
    ...
    latestTimestamp, options) {
        ...
        const cuePointIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(this.internalTrack.cuePoints, searchTimestamp, x => x.time);
        const cuePoint = cuePointIndex !== -1
            ? this.internalTrack.cuePoints[cuePointIndex]
            : null;
        // Also check the position cache
        const positionCacheIndex = (0,_misc_js__rspack_import_3/* .binarySearchLessOrEqual */.eE)(this.internalTrack.clusterPositionCache, searchTimestamp, x => x.startTimestamp);
        const positionCacheEntry = positionCacheIndex !== -1
        ...
        while (segment.elementEndPos === null || currentPos <= segment.elementEndPos - _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De) {
            if (currentCluster) {
            ...
            // Load the header
            let slice = demuxer.reader.requestSliceRange(currentPos, _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De, _ebml_js__rspack_import_0/* .MAX_HEADER_SIZE */.r1);
            if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(slice))
                slice = await slice;
            if (!slice)
                break;
            const elementStartPos = currentPos;
            const elementHeader = (0,_ebml_js__rspack_import_0/* .readElementHeader */.ur)(slice);
            if (!elementHeader
                || (!_ebml_js__rspack_import_0/* .LEVEL_1_EBML_IDS.includes */.VE.includes(elementHeader.id) && elementHeader.id !== _ebml_js__rspack_import_0/* .EBMLId.Void */.Cl.Void)) {
                ...
                const nextPos = await (0,_ebml_js__rspack_import_0/* .resync */.nE)(demuxer.reader, elementStartPos, _ebml_js__rspack_import_0/* .LEVEL_1_EBML_IDS */.VE, Math.min(segment.elementEndPos ?? Infinity, elementStartPos + MAX_RESYNC_LENGTH));
                if (nextPos) {
                    currentPos = nextPos;
                    continue;
                }
            ...
            let size = elementHeader.size;
            const dataStartPos = slice.filePos;
            if (id === _ebml_js__rspack_import_0/* .EBMLId.Cluster */.Cl.Cluster) {
            ...
            if (size === undefined) {
                ...
                (0,_misc_js__rspack_import_3/* .assert */.vA)(id !== _ebml_js__rspack_import_0/* .EBMLId.Cluster */.Cl.Cluster); // Undefined cluster sizes are fixed further up
                // Search for the next element at level 0 or 1
                const nextElementPos = await (0,_ebml_js__rspack_import_0/* .searchForNextElementId */.IQ)(demuxer.reader, dataStartPos, _ebml_js__rspack_import_0/* .LEVEL_0_AND_1_EBML_IDS */.K9, segment.elementEndPos);
                size = nextElementPos.pos - dataStartPos;
            }
            ...
            if (segment.elementEndPos === null) {
                ...
                // the first segment.
                let slice = demuxer.reader.requestSliceRange(endPos, _ebml_js__rspack_import_0/* .MIN_HEADER_SIZE */.De, _ebml_js__rspack_import_0/* .MAX_HEADER_SIZE */.r1);
                if ((0,_misc_js__rspack_import_3/* .isThenable */.Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const elementId = (0,_ebml_js__rspack_import_0/* .readElementId */.SR)(slice);
                if (elementId === _ebml_js__rspack_import_0/* .EBMLId.Segment */.Cl.Segment) {
        ...
        if (cuePoint && (!bestCluster || bestCluster.elementStartPos < cuePoint.clusterPosition)) {
            ...
            (0,_misc_js__rspack_import_3/* .assert */.vA)(!previousCuePoint || previousCuePoint.time < cuePoint.time);
        ...
        return this.decoderConfigPromise ??= (async () => {
            ...
            const codecInfo = {
                ...
                avcCodecInfo: this.internalTrack.info.codec === 'avc' && firstPacket
                    ? (0,_codec_data_js__rspack_import_9/* .extractAvcDecoderConfigurationRecord */.fH)(firstPacket.data)
                    : null,
                hevcCodecInfo: this.internalTrack.info.codec === 'hevc' && firstPacket
                    ? (0,_codec_data_js__rspack_import_9/* .extractHevcDecoderConfigurationRecord */.D5)(firstPacket.data)
                    : null,
                vp9CodecInfo: this.internalTrack.info.codec === 'vp9' && firstPacket
                    ? (0,_codec_data_js__rspack_import_9/* .extractVp9CodecInfoFromPacket */.bs)(firstPacket.data)
                    : null,
                av1CodecInfo: this.internalTrack.info.codec === 'av1' && firstPacket
                    ? (0,_codec_data_js__rspack_import_9/* .extractAv1CodecInfoFromPacket */.UU)(firstPacket.data)
                    : null,
                proresCodecInfo: this.internalTrack.info.codec === 'prores' && firstPacket
                    ? (0,_codec_data_js__rspack_import_9/* .extractProresCodecInfoFromPacket */.RU)(firstPacket.data)
                    : null,
                proresFormat: this.internalTrack.info.proresFormat,
            };
            if (!(0,_misc_js__rspack_import_3/* .colorSpaceIsComplete */.HV)(this.internalTrack.info.colorSpace)) {
                const colorSpace = (0,_codec_js__rspack_import_7/* .extractColorSpace */.LD)(codecInfo);
                // Fill the missing values
                this.internalTrack.info.colorSpace.primaries ??= colorSpace.primaries;
                this.internalTrack.info.colorSpace.transfer ??= colorSpace.transfer;
                this.internalTrack.info.colorSpace.matrix ??= colorSpace.matrix;
            ...
            const config = {
                codec: (0,_codec_js__rspack_import_7/* .extractVideoCodecString */.QP)(codecInfo),
                codedWidth: this.internalTrack.info.width,
                codedHeight: this.internalTrack.info.height,
                description: this.internalTrack.info.codecDescription ?? undefined,
                colorSpace: this.internalTrack.info.colorSpace,
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'dts' && !this.internalTrack.info.dtsFormat) {
                // Gotta check the packet to determine the DTS variant
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.dtsFormat = firstPacket && (0,_codec_data_js__rspack_import_9/* .extractDtsFourCcFromPacket */.n$)(firstPacket.data);
            }
            return {
                codec: (0,_codec_js__rspack_import_7/* .extractAudioCodecString */.X0)({
                    codec: this.internalTrack.info.codec,
                    codecDescription: this.internalTrack.info.codecDescription,
...
3616(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  V: () => (buildMatroskaMimeType)
});
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
...
456(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  l: () => (Mp3Demuxer)
});
/* import */ var _demuxer_js__rspack_import_0 = __webpack_require__(7202);
/* import */ var _metadata_js__rspack_import_6 = __webpack_require__(5165);
/* import */ var _misc_js__rspack_import_1 = __webpack_require__(3912);
/* import */ var _packet_js__rspack_import_7 = __webpack_require__(3936);
/* import */ var _shared_mp3_misc_js__rspack_import_4 = __webpack_require__(2788);
/* import */ var _id3_js__rspack_import_2 = __webpack_require__(7576);
/* import */ var _mp3_reader_js__rspack_import_3 = __webpack_require__(6757);
/* import */ var _reader_js__rspack_import_5 = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class Mp3Demuxer extends _demuxer_js__rspack_import_0/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
        this.firstFrameHeader = null;
    ...
    async advanceReader() {
        ...
        const result = await (0,_mp3_reader_js__rspack_import_3/* .readNextMp3FrameHeader */.W)(this.reader, this.lastLoadedPos, this.reader.fileSize, this.firstFrameHeader);
        if (!result) {
            this.lastSampleLoaded = true;
            return;
        }
        ...
        const xingOffset = (0,_shared_mp3_misc_js__rspack_import_4/* .getXingOffset */.EZ)(header.mpegVersionId, header.channel);
        let slice = this.reader.requestSlice(result.startPos + xingOffset, 4);
        if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(slice))
            slice = await slice;
        if (slice) {
            const word = (0,_reader_js__rspack_import_5/* .readU32Be */.cN)(slice);
            const isXing = word === _shared_mp3_misc_js__rspack_import_4/* .XING */.hY || word === _shared_mp3_misc_js__rspack_import_4/* .INFO */.rD;
            if (isXing) {
                ...
                if (!this.xingData) {
                    ...
                    if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(xingDataSlice))
                        xingDataSlice = await xingDataSlice;
                    if (xingDataSlice) {
                        const xingData = (0,_reader_js__rspack_import_5/* .readBytes */.io)(xingDataSlice, 12);
                        const view = (0,_misc_js__rspack_import_1/* .toDataView */.Zc)(xingData);
                        const flags = view.getUint32(0, false);
                        this.xingData = {
                            frameCount: (flags & _shared_mp3_misc_js__rspack_import_4/* .XingFlags.FrameCount */.MJ.FrameCount)
                                ? view.getUint32(4, false)
                                : null,
                            fileSize: (flags & _shared_mp3_misc_js__rspack_import_4/* .XingFlags.FileSize */.MJ.FileSize)
    ...
    async getMetadataTags() {
        ...
        try {
            ...
            if (!id3V2HeaderFound && this.reader.fileSize !== null && this.reader.fileSize >= _id3_js__rspack_import_2/* .ID3_V1_TAG_SIZE */.aU) {
                // Try reading an ID3v1 tag at the end of the file
                let slice = this.reader.requestSlice(this.reader.fileSize - _id3_js__rspack_import_2/* .ID3_V1_TAG_SIZE */.aU, _id3_js__rspack_import_2/* .ID3_V1_TAG_SIZE */.aU);
                if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(slice))
                    slice = await slice;
                (0,_misc_js__rspack_import_1/* .assert */.vA)(slice);
                const tag = (0,_reader_js__rspack_import_5/* .readAscii */.IT)(slice, 3);
                if (tag === 'TAG') {
                    (0,_id3_js__rspack_import_2/* .parseId3V1Tag */.p_)(slice, this.metadataTags);
                }
            }
            return this.metadataTags;
        }
...
class Mp3AudioTrackBacking {
    ...
    async getDurationFromMetadata() {
        ...
        (0,_misc_js__rspack_import_1/* .assert */.vA)(demuxer.firstFrameHeader !== null);
        (0,_misc_js__rspack_import_1/* .assert */.vA)(demuxer.firstFrameHeaderPos !== null);
        if (demuxer.xingData) {
            ...
            if (demuxer.reader.fileSize !== null) {
                const averageFrameSize = (0,_shared_mp3_misc_js__rspack_import_4/* .computeAverageMp3FrameSize */.hD)(demuxer.firstFrameHeader.lowSamplingFrequency, demuxer.firstFrameHeader.layer, demuxer.firstFrameHeader.bitrate, demuxer.firstFrameHeader.sampleRate);
    ...
    getNumberOfChannels() {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.firstFrameHeader);
        return (0,_shared_mp3_misc_js__rspack_import_4/* .getMp3ChannelCount */.fX)(this.demuxer.firstFrameHeader.channel);
    }
    getSampleRate() {
        (0,_misc_js__rspack_import_1/* .assert */.vA)(this.demuxer.firstFrameHeader);
    ...
    async getDecoderConfig() {
        ...
        return {
            codec: 'mp3',
            numberOfChannels: (0,_shared_mp3_misc_js__rspack_import_4/* .getMp3ChannelCount */.fX)(this.demuxer.firstFrameHeader.channel),
    ...
    async getPacketAtIndex(sampleIndex, options) {
        ...
        let data;
        if (options.metadataOnly) {
            data = _packet_js__rspack_import_7/* .PLACEHOLDER_DATA */.T;
        }
        else {
            let slice = this.demuxer.reader.requestSlice(rawSample.dataStart, rawSample.dataSize);
            if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(slice))
            ...
            data = (0,_reader_js__rspack_import_5/* .readBytes */.io)(slice, rawSample.dataSize);
        }
        return new _packet_js__rspack_import_7/* .EncodedPacket */.Z(data, 'key', rawSample.timestamp, rawSample.duration, sampleIndex, rawSample.dataSize);
    }
    getFirstPacket(options) {
        return this.getPacketAtIndex(0, options);
    }
...
6757(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  W: () => (readNextMp3FrameHeader)
});
/* import */ var _shared_mp3_misc_js__rspack_import_0 = __webpack_require__(2788);
/* import */ var _misc_js__rspack_import_1 = __webpack_require__(3912);
/* import */ var _reader_js__rspack_import_2 = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
const readNextMp3FrameHeader = async (reader, startPos, until, ref = null) => {
    ...
    while (until === null || currentPos < until) {
        const maxLength = until !== null
            ...
            : CHUNK_SIZE;
        let slice = reader.requestSliceRange(currentPos, (/* inlined export .MP3_FRAME_HEADER_SIZE */4), maxLength);
        if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(slice))
            slice = await slice;
        if (!slice || slice.length < (/* inlined export .MP3_FRAME_HEADER_SIZE */4))
            break;
        while (slice.remainingLength >= (/* inlined export .MP3_FRAME_HEADER_SIZE */4)) {
            const posBeforeRead = slice.filePos;
            const word = (0,_reader_js__rspack_import_2/* .readU32Be */.cN)(slice);
            const remainingBytes = reader.fileSize !== null
                ? reader.fileSize - currentPos
                : null;
            const result = (0,_shared_mp3_misc_js__rspack_import_0/* .readMp3FrameHeader */.P8)(word, remainingBytes);
            if (result.header
                && (!ref || (
                ...
                result.header.sampleRate === ref.sampleRate
                    ...
                    && (0,_shared_mp3_misc_js__rspack_import_0/* .getMp3ChannelCount */.fX)(result.header.channel) === (0,_shared_mp3_misc_js__rspack_import_0/* .getMp3ChannelCount */.fX)(ref.channel)))) {
...
7540(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  f: () => (MpegTsDemuxer)
});
/* import */ var _adts_adts_demuxer_js__rspack_import_14 = __webpack_require__(9086);
/* import */ var _adts_adts_reader_js__rspack_import_8 = __webpack_require__(8475);
/* import */ var _shared_aac_misc_js__rspack_import_9 = __webpack_require__(1299);
/* import */ var _codec_js__rspack_import_7 = __webpack_require__(1188);
/* import */ var _codec_data_js__rspack_import_6 = __webpack_require__(6297);
/* import */ var _demuxer_js__rspack_import_0 = __webpack_require__(7202);
/* import */ var _logging_js__rspack_import_5 = __webpack_require__(6103);
/* import */ var _metadata_js__rspack_import_12 = __webpack_require__(5165);
/* import */ var _misc_js__rspack_import_2 = __webpack_require__(3912);
/* import */ var _shared_mp3_misc_js__rspack_import_10 = __webpack_require__(2788);
/* import */ var _packet_js__rspack_import_13 = __webpack_require__(3936);
/* import */ var _reader_js__rspack_import_3 = __webpack_require__(7735);
/* import */ var _mpeg_ts_misc_js__rspack_import_1 = __webpack_require__(2490);
/* import */ var _shared_ac3_misc_js__rspack_import_11 = __webpack_require__(7553);
/* import */ var _shared_bitstream_js__rspack_import_4 = __webpack_require__(1390);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class MpegTsDemuxer extends _demuxer_js__rspack_import_0/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
    ...
    async readMetadata() {
        return this.metadataPromise ??= (async () => {
            const lengthToCheck = (/* inlined export .TS_PACKET_SIZE */188) + 16 + 1;
            let startingSlice = this.reader.requestSlice(0, lengthToCheck);
            if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(startingSlice))
                startingSlice = await startingSlice;
            (0,_misc_js__rspack_import_2/* .assert */.vA)(startingSlice);
            const startingBytes = (0,_reader_js__rspack_import_3/* .readBytes */.io)(startingSlice, lengthToCheck);
            if (startingBytes[0] === 0x47 && startingBytes[(/* inlined export .TS_PACKET_SIZE */188)] === 0x47) {
                // Regular MPEG-TS
                this.packetOffset = 0;
                this.packetStride = (/* inlined export .TS_PACKET_SIZE */188);
            }
            else if (startingBytes[0] === 0x47 && startingBytes[(/* inlined export .TS_PACKET_SIZE */188) + 16] === 0x47) {
                // MPEG-TS with Forward Error Correction
                this.packetOffset = 0;
                this.packetStride = (/* inlined export .TS_PACKET_SIZE */188) + 16;
            }
            else if (startingBytes[4] === 0x47 && startingBytes[4 + (/* inlined export .TS_PACKET_SIZE */188) + 4] === 0x47) {
                // MPEG-2-TS (DVHS)
                this.packetOffset = 4;
                this.packetStride = (/* inlined export .TS_PACKET_SIZE */188) + 4;
            }
            else {
            ...
            while (true) {
                ...
                if (!hasProgramMap && section.pid !== 0) {
                    ...
                    if (!isPesPacket) {
                        // Assume it's a PSI
                        const bitstream = new _shared_bitstream_js__rspack_import_4/* .Bitstream */._(section.payload);
                        ...
                        switch (effectiveStreamType) {
                            ...
                            default: {
                                ...
                                if (!ignoredStreamTypes.has(streamType)) {
                                    _logging_js__rspack_import_5/* .Logging._warn */.y._warn(`Note: MPEG-TS streams with stream_type 0x${streamType.toString(16)} are not`
                                        + ` currently supported.`);
                    ...
                    outer: if (elementaryStream && !elementaryStream.initialized) {
                        ...
                        if (elementaryStream.info.type === 'video') {
                            ...
                            while (true) {
                                ...
                                if (elementaryStream.info.codec === 'avc') {
                                    ...
                                    elementaryStream.info.avcCodecInfo
                                        = (0,_codec_data_js__rspack_import_6/* .extractAvcDecoderConfigurationRecord */.fH)(context.suppliedPacket.data);
                                    ...
                                    (0,_misc_js__rspack_import_2/* .assert */.vA)(spsUnit);
                                    const spsInfo = (0,_codec_data_js__rspack_import_6/* .parseAvcSps */.eM)(spsUnit);
                                    ...
                                    elementaryStream.info.colorSpace = {
                                        primaries: _misc_js__rspack_import_2/* .COLOR_PRIMARIES_MAP_INVERSE */.BL[spsInfo.colourPrimaries],
                                        transfer: _misc_js__rspack_import_2/* .TRANSFER_CHARACTERISTICS_MAP_INVERSE */.x_[spsInfo.transferCharacteristics],
                                        matrix: _misc_js__rspack_import_2/* .MATRIX_COEFFICIENTS_MAP_INVERSE */.fl[spsInfo.matrixCoefficients],
                                    ...
                                    elementaryStream.info.hevcCodecInfo
                                        = (0,_codec_data_js__rspack_import_6/* .extractHevcDecoderConfigurationRecord */.D5)(context.suppliedPacket.data);
                                    if (!elementaryStream.info.hevcCodecInfo) {
                                        continue; // Search the next packet for it
                                    }
                                    const spsArray = elementaryStream.info.hevcCodecInfo.arrays.find(a => a.nalUnitType === _codec_data_js__rspack_import_6/* .HevcNalUnitType.SPS_NUT */.iJ.SPS_NUT);
                                    const spsUnit = spsArray.nalUnits[0];
                                    (0,_misc_js__rspack_import_2/* .assert */.vA)(spsUnit);
                                    const spsInfo = (0,_codec_data_js__rspack_import_6/* .parseHevcSps */.gT)(spsUnit);
                                    elementaryStream.info.width = spsInfo.displayWidth;
                                    elementaryStream.info.height = spsInfo.displayHeight;
                            ...
                            elementaryStream.info.decoderConfig = {
                                codec: (0,_codec_js__rspack_import_7/* .extractVideoCodecString */.QP)({
                            ...
                            if (elementaryStream.info.codec === 'aac') {
                                const slice = _reader_js__rspack_import_3/* .FileSlice.tempFromBytes */.x$.tempFromBytes(context.suppliedPacket.data);
                                const header = (0,_adts_adts_reader_js__rspack_import_8/* .readAdtsFrameHeader */.lh)(slice);
                                if (!header) {
                                ...
                                elementaryStream.info.numberOfChannels
                                    = _shared_aac_misc_js__rspack_import_9/* .aacChannelMap */.Ti[header.channelConfiguration];
                                elementaryStream.info.sampleRate
                                    = _shared_aac_misc_js__rspack_import_9/* .aacFrequencyTable */.Im[header.samplingFrequencyIndex];
                            }
                            else if (elementaryStream.info.codec === 'mp3') {
                                const word = (0,_reader_js__rspack_import_3/* .readU32Be */.cN)(_reader_js__rspack_import_3/* .FileSlice.tempFromBytes */.x$.tempFromBytes(context.suppliedPacket.data));
                                const result = (0,_shared_mp3_misc_js__rspack_import_10/* .readMp3FrameHeader */.P8)(word, context.suppliedPacket.data.byteLength);
                                if (!result.header) {
                                    throw new Error('Invalid MP3 audio stream; could not read frame header from first packet.');
                                }
                                elementaryStream.info.numberOfChannels = (0,_shared_mp3_misc_js__rspack_import_10/* .getMp3ChannelCount */.fX)(result.header.channel);
                                elementaryStream.info.sampleRate = result.header.sampleRate;
                            }
                            else if (elementaryStream.info.codec === 'ac3') {
                                const frameInfo = (0,_codec_data_js__rspack_import_6/* .parseAc3SyncFrame */.LM)(context.suppliedPacket.data);
                                if (!frameInfo) {
                                ...
                                elementaryStream.info.numberOfChannels
                                    = _codec_data_js__rspack_import_6/* .AC3_ACMOD_CHANNEL_COUNTS */.ux[frameInfo.acmod] + frameInfo.lfeon;
                                elementaryStream.info.sampleRate = _shared_ac3_misc_js__rspack_import_11/* .AC3_SAMPLE_RATES */.N[frameInfo.fscod];
                            }
                            else if (elementaryStream.info.codec === 'eac3') {
                                const frameInfo = (0,_codec_data_js__rspack_import_6/* .parseEac3SyncFrame */.oL)(context.suppliedPacket.data);
                                if (!frameInfo) {
                                    throw new Error('Invalid E-AC-3 audio stream; could not read sync frame from first packet.');
                                }
                                const sampleRate = (0,_codec_data_js__rspack_import_6/* .getEac3SampleRate */.PK)(frameInfo);
                                if (sampleRate === null) {
                                    throw new Error('Invalid E-AC-3 audio stream; reserved sample rate code found in first packet.');
                                }
                                elementaryStream.info.numberOfChannels = (0,_codec_data_js__rspack_import_6/* .getEac3ChannelCount */.zV)(frameInfo);
                                elementaryStream.info.sampleRate = sampleRate;
                            }
                            else if (elementaryStream.info.codec === 'dts') {
                                const frameInfo = (0,_codec_data_js__rspack_import_6/* .parseDtsFrame */.CX)(context.suppliedPacket.data);
                                if (!frameInfo) {
    ...
    async getMimeType() {
        ...
        return (0,_mpeg_ts_misc_js__rspack_import_1/* .buildMpegTsMimeType */.V)(codecStrings);
    }
    async readSection(startPos, full, contiguous = false) {
        ...
        while (true) {
            ...
            const isKnownSectionEnd = (0,_misc_js__rspack_import_2/* .binarySearchExact */.pl)(this.sectionEndPositions, endPos, x => x) !== -1;
        ...
        if (mustAddSectionEnd) {
            const index = (0,_misc_js__rspack_import_2/* .binarySearchLessOrEqual */.eE)(this.sectionEndPositions, endPos, x => x);
    ...
    async readPacketHeader(pos) {
        ...
        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(slice))
            slice = await slice;
        if (!slice) {
            return null;
        }
        const syncByte = (0,_reader_js__rspack_import_3/* .readU8 */.eo)(slice);
        if (syncByte !== 0x47) {
            throw new Error('Invalid TS packet sync byte. Likely an internal bug, please report this file.');
        }
        const nextTwoBytes = (0,_reader_js__rspack_import_3/* .readU16Be */.mH)(slice);
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    async readPacket(pos) {
        ...
        let slice = this.reader.requestSlice(pos, (/* inlined export .TS_PACKET_SIZE */188));
        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(slice))
            slice = await slice;
        if (!slice) {
            return null;
        }
        const bytes = (0,_reader_js__rspack_import_3/* .readBytes */.io)(slice, (/* inlined export .TS_PACKET_SIZE */188));
...
const readPesPacket = (section, expectPts) => {
    (0,_misc_js__rspack_import_2/* .assert */.vA)(section.endPos !== null); // Can only read full PES packets from fully read sections
    ...
    (0,_misc_js__rspack_import_2/* .assert */.vA)(Number.isInteger(bytePos));
...
class MpegTsTrackBacking {
    ...
    getNumber() {
        ...
        for (const backing of demuxer.trackBackingEntries) {
            ...
            (0,_misc_js__rspack_import_2/* .assert */.vA)(backing instanceof MpegTsTrackBacking);
    ...
    getLanguageCode() {
        return _misc_js__rspack_import_2/* .UNDETERMINED_LANGUAGE */.IR;
    }
    getDisposition() {
        return {
            ..._metadata_js__rspack_import_12/* .DEFAULT_TRACK_DISPOSITION */.gM,
            primary: false,
        };
    }
    getTimeResolution() {
        return (/* inlined export .TIMESCALE */90000);
    }
    isRelativeToUnixEpoch() {
        return false;
    }
    ...
    createEncodedPacket(suppliedPacket, duration, options) {
        ...
        return new _packet_js__rspack_import_13/* .EncodedPacket */.Z(options.metadataOnly ? _packet_js__rspack_import_13/* .PLACEHOLDER_DATA */.T : suppliedPacket.data, packetType, suppliedPacket.pts / (/* inlined export .TIMESCALE */90000), Math.max(duration / (/* inlined export .TIMESCALE */90000), 0), suppliedPacket.sequenceNumber, suppliedPacket.data.byteLength);
    }
    async getFirstPacket(options) {
        const section = this.elementaryStream.firstSection;
        (0,_misc_js__rspack_import_2/* .assert */.vA)(section);
        const pesPacket = readPesPacket(section, true);
        (0,_misc_js__rspack_import_2/* .assert */.vA)(pesPacket);
    ...
    async doPacketLookup(timestamp, keyframesOnly, options) {
        const searchPts = (0,_misc_js__rspack_import_2/* .roundIfAlmostInteger */.aI)(timestamp * (/* inlined export .TIMESCALE */90000));
        const demuxer = this.elementaryStream.demuxer;
        ...
        (0,_misc_js__rspack_import_2/* .assert */.vA)(firstSection);
        const firstPesPacketHeader = readPesPacketHeader(firstSection, true);
        (0,_misc_js__rspack_import_2/* .assert */.vA)(firstPesPacketHeader);
        ...
        const referencePointIndex = (0,_misc_js__rspack_import_2/* .binarySearchLessOrEqual */.eE)(referencePesPackets, searchPts, x => x.pts);
        const referencePoint = referencePointIndex !== -1 ? referencePesPackets[referencePointIndex] : null;
        if (referencePoint && searchPts - referencePoint.pts < (/* inlined export .TIMESCALE */90000) / 2) {
            ...
            if (reader.fileSize !== null) {
                ...
                if (numChunks > 1) {
                    ...
                    while (low <= high) {
                        ...
                        const chunkStartPos = (0,_misc_js__rspack_import_2/* .floorToMultiple */.Q5)(mid * seekChunkSize, demuxer.packetStride)
            ...
            scanStartPos = (0,_misc_js__rspack_import_2/* .floorToMultiple */.Q5)(startChunkIndex * seekChunkSize, demuxer.packetStride) + firstPesPacketHeader.sectionStartPos;
        }
        ...
        const retrieveEncodedPacket = async (sectionStartPos, predicate) => {
            ...
            while (true) {
                const topPts = (0,_misc_js__rspack_import_2/* .last */._g)(buffer.presentationOrderPackets)?.pts ?? -Infinity;
                if (topPts >= searchPts) {
                    break;
                }
            ...
            const targetIndex = (0,_misc_js__rspack_import_2/* .findLastIndex */.Kl)(buffer.presentationOrderPackets, predicate);
            if (targetIndex === -1) {
                return null;
            }
            ...
            const result = await buffer.readNext();
            (0,_misc_js__rspack_import_2/* .assert */.vA)(result);
            const packet = this.createEncodedPacket(result.packet, result.duration, options);
            this.packetBuffers.set(packet, buffer);
            this.packetSectionStarts.set(packet, result.packet.sectionStartPos);
            return packet;
        ...
        if (!keyframesOnly || this.allPacketsAreKeyPackets()) {
            ...
            while (true) {
                ...
                outer: while (pesHeader) {
                    ...
                    if (pesHeader.pts <= searchPts) {
                        ...
                        if (this.elementaryStream.canBeTrustedWithKeyPackets) {
                            ...
                            (0,_misc_js__rspack_import_2/* .assert */.vA)(pesHeaderSection);
                ...
                if (bestKeyPesHeader) {
                    ...
                    (0,_misc_js__rspack_import_2/* .assert */.vA)(encodedPacket); // There must be one
                ...
                currentChunkStartPos = Math.max((0,_misc_js__rspack_import_2/* .floorToMultiple */.Q5)(currentChunkStartPos - firstPesPacketHeader.sectionStartPos - seekChunkSize, demuxer.packetStride) + firstPesPacketHeader.sectionStartPos, firstPesPacketHeader.sectionStartPos);
            }
        }
    }
}
class MpegTsVideoTrackBacking extends MpegTsTrackBacking {
    ...
    async getDecoderConfig() {
        (0,_misc_js__rspack_import_2/* .assert */.vA)(this.elementaryStream.info.decoderConfig);
...
const maybeInsertReferencePacket = (elementaryStream, pesPacketHeader) => {
    ...
    const index = (0,_misc_js__rspack_import_2/* .binarySearchLessOrEqual */.eE)(referencePesPackets, pesPacketHeader.sectionStartPos, x => x.sectionStartPos);
    if (index >= 0) {
...
class PacketReadingContext {
    ...
    getCurrentPesPacket() {
        ...
        (0,_misc_js__rspack_import_2/* .assert */.vA)(packet);
        return packet;
    }
    async bufferData(length) {
        ...
        while (this.endPos < targetEndPos) {
            ...
            if (this.pesPackets.length === 0) {
                ...
                let currentPos = (0,_misc_js__rspack_import_2/* .last */._g)(this.pesPackets).sectionEndPos;
                (0,_misc_js__rspack_import_2/* .assert */.vA)(currentPos !== null);
                while (true) {
    ...
    async markNextPacket() {
        (0,_misc_js__rspack_import_2/* .assert */.vA)(!this.suppliedPacket);
        ...
        if (elementaryStream.info.type === 'video') {
            ...
            while (true) {
                ...
                if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                ...
                while (i < length) {
                    ...
                    if (codec === 'avc') {
                        nalUnitType = (0,_codec_data_js__rspack_import_6/* .extractNalUnitTypeForAvc */.uN)(headerByte0);
                        isSlice = nalUnitType === _codec_data_js__rspack_import_6/* .AvcNalUnitType.NON_IDR_SLICE */.mY.NON_IDR_SLICE
                            || nalUnitType === _codec_data_js__rspack_import_6/* .AvcNalUnitType.SLICE_DPA */.mY.SLICE_DPA
                            || nalUnitType === _codec_data_js__rspack_import_6/* .AvcNalUnitType.IDR */.mY.IDR;
                        isAccessUnitStart = nalUnitType === _codec_data_js__rspack_import_6/* .AvcNalUnitType.SEI */.mY.SEI
                            || nalUnitType === _codec_data_js__rspack_import_6/* .AvcNalUnitType.SPS */.mY.SPS
                            || nalUnitType === _codec_data_js__rspack_import_6/* .AvcNalUnitType.PPS */.mY.PPS
                            || nalUnitType === _codec_data_js__rspack_import_6/* .AvcNalUnitType.AUD */.mY.AUD;
                    }
                    else {
                        nalUnitType = (0,_codec_data_js__rspack_import_6/* .extractNalUnitTypeForHevc */.O9)(headerByte0);
                        ...
                        isSlice = nalUnitType <= _codec_data_js__rspack_import_6/* .HevcNalUnitType.RASL_R */.iJ.RASL_R
                            || (nalUnitType >= _codec_data_js__rspack_import_6/* .HevcNalUnitType.BLA_W_LP */.iJ.BLA_W_LP && nalUnitType <= 21);
                        // VPS..FD, prefix SEI, and the reserved/unspecified non-VCL ranges
                        isAccessUnitStart = (nalUnitType >= _codec_data_js__rspack_import_6/* .HevcNalUnitType.VPS_NUT */.iJ.VPS_NUT && nalUnitType <= 37)
                            || nalUnitType === _codec_data_js__rspack_import_6/* .HevcNalUnitType.PREFIX_SEI_NUT */.iJ.PREFIX_SEI_NUT
                    ...
                    if (isSlice) {
                        ...
                        if (codec === 'avc') {
                            ...
                            const firstMacroblockInSlice = (0,_misc_js__rspack_import_2/* .readExpGolomb */.IP)(new _shared_bitstream_js__rspack_import_4/* .Bitstream */._(headerBytes));
            ...
            while (true) {
                ...
                while (this.currentPos - startPos < remaining) {
                    ...
                    if (codec === 'aac') {
                        ...
                        let remaining = this.ensureBuffered(_adts_adts_reader_js__rspack_import_8/* .MAX_ADTS_FRAME_HEADER_SIZE */.Y$);
                        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                            remaining = await remaining;
                        if (remaining < _adts_adts_reader_js__rspack_import_8/* .MAX_ADTS_FRAME_HEADER_SIZE */.Y$) {
                            return;
                        }
                        const headerBytes = this.readBytes(_adts_adts_reader_js__rspack_import_8/* .MAX_ADTS_FRAME_HEADER_SIZE */.Y$);
                        const header = (0,_adts_adts_reader_js__rspack_import_8/* .readAdtsFrameHeader */.lh)(_reader_js__rspack_import_3/* .FileSlice.tempFromBytes */.x$.tempFromBytes(headerBytes));
                        if (header) {
                            this.seekTo(possibleHeaderStartPos);
                            let remaining = this.ensureBuffered(header.frameLength);
                            if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                                remaining = await remaining;
                            return this.supplyPacket(remaining, Math.round(_adts_adts_demuxer_js__rspack_import_14/* .SAMPLES_PER_AAC_FRAME */.s * (/* inlined export .TIMESCALE */90000) / elementaryStream.info.sampleRate));
                        }
                        else {
                        ...
                        this.skip(-1);
                        const possibleHeaderStartPos = this.currentPos;
                        let remaining = this.ensureBuffered((/* inlined export .MP3_FRAME_HEADER_SIZE */4));
                        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                            remaining = await remaining;
                        if (remaining < (/* inlined export .MP3_FRAME_HEADER_SIZE */4)) {
                            return;
                        }
                        const headerBytes = this.readBytes((/* inlined export .MP3_FRAME_HEADER_SIZE */4));
                        const word = (0,_misc_js__rspack_import_2/* .toDataView */.Zc)(headerBytes).getUint32(0);
                        const result = (0,_shared_mp3_misc_js__rspack_import_10/* .readMp3FrameHeader */.P8)(word, null);
                        if (result.header) {
                            this.seekTo(possibleHeaderStartPos);
                            let remaining = this.ensureBuffered(result.header.totalSize);
                            if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                                remaining = await remaining;
                            const duration = result.header.audioSamplesInFrame * (/* inlined export .TIMESCALE */90000)
                                / elementaryStream.info.sampleRate;
                        ...
                        const frameSize = _codec_data_js__rspack_import_6/* .AC3_FRAME_SIZES */.Pl[3 * frmsizecod + fscod];
                        (0,_misc_js__rspack_import_2/* .assert */.vA)(frameSize !== undefined);
                        this.seekTo(possibleSyncPos);
                        remaining = this.ensureBuffered(frameSize);
                        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                            remaining = await remaining;
                        const duration = Math.round(_codec_data_js__rspack_import_6/* .AC3_SAMPLES_PER_FRAME */.Ir * (/* inlined export .TIMESCALE */90000) / elementaryStream.info.sampleRate);
                        ...
                        const numblks = _codec_data_js__rspack_import_6/* .EAC3_NUMBLKS_TABLE */.FY[numblkscod];
                        this.seekTo(possibleSyncPos);
                        remaining = this.ensureBuffered(frameSize);
                        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                            remaining = await remaining;
                        ...
                        const duration = Math.round(samplesPerFrame * (/* inlined export .TIMESCALE */90000) / elementaryStream.info.sampleRate);
                        return this.supplyPacket(remaining, duration);
                    }
                    else if (codec === 'dts') {
                        ...
                        this.skip(-1);
                        const possibleSyncPos = this.currentPos;
                        let remaining = this.ensureBuffered(_codec_data_js__rspack_import_6/* .DTS_CORE_FRAME_HEADER_SIZE */.mB);
                        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                            remaining = await remaining;
                        if (remaining < _codec_data_js__rspack_import_6/* .DTS_CORE_FRAME_HEADER_SIZE */.mB) {
                            return;
                        }
                        const headerBytes = this.readBytes(_codec_data_js__rspack_import_6/* .DTS_CORE_FRAME_HEADER_SIZE */.mB);
                        const core = (0,_codec_data_js__rspack_import_6/* .parseDtsCoreFrameHeader */.Wt)(headerBytes);
                        let leadingExss = core ? null : (0,_codec_data_js__rspack_import_6/* .parseDtsExssHeader */.Zt)(headerBytes);
                        if (!core && !leadingExss) {
                            this.seekTo(possibleSyncPos + 1);
                            continue;
                        }
                        if (leadingExss && !leadingExss.asset) {
                            ...
                            this.seekTo(possibleSyncPos);
                            const headerBound = Math.min(leadingExss.frameSize, _codec_data_js__rspack_import_6/* .DTS_EXSS_MAX_HEADER_SIZE */.$N);
                            let remaining = this.ensureBuffered(headerBound);
                            if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                                remaining = await remaining;
                            leadingExss = (0,_codec_data_js__rspack_import_6/* .parseDtsExssHeader */.Zt)(this.readBytes(remaining)) ?? leadingExss;
                        }
                        ...
                        if (core) {
                            ...
                            while (true) {
                                this.seekTo(possibleSyncPos);
                                const neededBytes = nextSubstreamPos + _codec_data_js__rspack_import_6/* .DTS_EXSS_HEADER_PREFIX_SIZE */.l9;
                                ...
                                const exss = (0,_codec_data_js__rspack_import_6/* .parseDtsExssHeader */.Zt)(this.readBytes(_codec_data_js__rspack_import_6/* .DTS_EXSS_HEADER_PREFIX_SIZE */.l9));
                                if (!exss) {
                                    break;
                                }
                        ...
                        if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(remaining))
                            remaining = await remaining;
                        const duration = Math.round(sampleCount * (/* inlined export .TIMESCALE */90000) / elementaryStream.info.sampleRate);
                        return this.supplyPacket(remaining, duration);
                    }
                    else {
                        throw new Error('Unhandled.');
    ...
    supplyPacket(packetLength, intrinsicDuration) {
        ...
        if (this.lastSuppliedPesPacket === currentPesPacket) {
            (0,_misc_js__rspack_import_2/* .assert */.vA)(this.nextPts !== null);
            pts = this.nextPts;
        }
        else {
        ...
        if (randomAccessIndicator === 0 && !this.elementaryStream.canBeTrustedWithKeyPackets) {
            if (this.elementaryStream.info.type === 'audio') {
                ...
                if (this.elementaryStream.info.decoderConfig) {
                    const isKey = (0,_codec_data_js__rspack_import_6/* .determineVideoPacketType */.PR)(this.elementaryStream.info.codec, this.elementaryStream.info.decoderConfig, data) === 'key';
...
class PacketBuffer {
    constructor(backing, context) {
        ...
        (0,_misc_js__rspack_import_2/* .assert */.vA)(this.reorderSize >= 0);
    }
    async readNext() {
        ...
        (0,_misc_js__rspack_import_2/* .assert */.vA)(presentationIndex !== -1);
        let duration;
    ...
    async ensureCurrentPacketHasNext() {
        ...
        (0,_misc_js__rspack_import_2/* .assert */.vA)(current);
        while (true) {
...
2490(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  V: () => (buildMpegTsMimeType)
});
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
...
588(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  S: () => (OggDemuxer)
});
/* import */ var _codec_js__rspack_import_4 = __webpack_require__(1188);
/* import */ var _codec_data_js__rspack_import_3 = __webpack_require__(6297);
/* import */ var _demuxer_js__rspack_import_0 = __webpack_require__(7202);
/* import */ var _metadata_js__rspack_import_7 = __webpack_require__(5165);
/* import */ var _misc_js__rspack_import_2 = __webpack_require__(3912);
/* import */ var _packet_js__rspack_import_8 = __webpack_require__(3936);
/* import */ var _reader_js__rspack_import_5 = __webpack_require__(7735);
/* import */ var _ogg_misc_js__rspack_import_6 = __webpack_require__(9730);
/* import */ var _ogg_reader_js__rspack_import_1 = __webpack_require__(9841);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class OggDemuxer extends _demuxer_js__rspack_import_0/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
        this.bitstreams = [];
    ...
    async readMetadata() {
        return this.metadataPromise ??= (async () => {
            let currentPos = 0;
            while (true) {
                let slice = this.reader.requestSliceRange(currentPos, _ogg_reader_js__rspack_import_1/* .MIN_PAGE_HEADER_SIZE */.b0, _ogg_reader_js__rspack_import_1/* .MAX_PAGE_HEADER_SIZE */.H9);
                if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const page = (0,_ogg_reader_js__rspack_import_1/* .readPageHeader */.BF)(slice);
                if (!page) {
                    break;
                }
    ...
    async readVorbisMetadata(firstPacket, bitstream) {
        ...
        const view = (0,_misc_js__rspack_import_2/* .toDataView */.Zc)(firstPacket.data);
        ...
        bitstream.codecInfo.vorbisInfo = {
            ...
            modeBlockflags: (0,_codec_data_js__rspack_import_3/* .parseModesFromVorbisSetupPacket */.Co)(thirdPacket.data).modeBlockflags,
        };
        (0,_codec_data_js__rspack_import_3/* .readVorbisComments */.Oc)(secondPacket.data.subarray(7), this.metadataTags); // Skip header type and 'vorbis'
    }
    async readOpusMetadata(firstPacket, bitstream) {
        ...
        const header = (0,_codec_data_js__rspack_import_3/* .parseOpusIdentificationHeader */.Qf)(firstPacket.data);
        bitstream.numberOfChannels = header.outputChannelCount;
        bitstream.sampleRate = _codec_js__rspack_import_4/* .OPUS_SAMPLE_RATE */.yo; // Always the same
        bitstream.codecInfo.opusInfo = {
            preSkip: header.preSkip,
        };
        (0,_codec_data_js__rspack_import_3/* .readVorbisComments */.Oc)(secondPacket.data.subarray(8), this.metadataTags); // Skip 'OpusTags'
    }
    async readPacket(startPage, startSegmentIndex) {
        (0,_misc_js__rspack_import_2/* .assert */.vA)(startSegmentIndex < startPage.lacingValues.length);
        ...
        outer: while (true) {
            ...
            if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(pageSlice))
                pageSlice = await pageSlice;
            (0,_misc_js__rspack_import_2/* .assert */.vA)(pageSlice);
            const pageData = (0,_reader_js__rspack_import_5/* .readBytes */.io)(pageSlice, currentPage.dataSize);
            while (true) {
            ...
            while (true) {
                let headerSlice = this.reader.requestSliceRange(currentPos, _ogg_reader_js__rspack_import_1/* .MIN_PAGE_HEADER_SIZE */.b0, _ogg_reader_js__rspack_import_1/* .MAX_PAGE_HEADER_SIZE */.H9);
                if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(headerSlice))
                    headerSlice = await headerSlice;
                if (!headerSlice) {
                    return null;
                }
                const nextPage = (0,_ogg_reader_js__rspack_import_1/* .readPageHeader */.BF)(headerSlice);
                if (!nextPage) {
                    return null;
                }
    ...
    async findNextPacketStart(lastPacket) {
        ...
        while (true) {
            ...
            const nextPage = (0,_ogg_reader_js__rspack_import_1/* .readPageHeader */.BF)(slice);
            if (!nextPage) {
                return null;
            }
    ...
    async getMimeType() {
        ...
        return (0,_ogg_misc_js__rspack_import_6/* .buildOggMimeType */.Ob)({
            codecStrings: codecStrings.filter(Boolean),
        });
    }
    async getTrackBackings() {
...
class OggAudioTrackBacking {
    constructor(bitstream, demuxer) {
        ...
        this.sequentialScanMutex = new _misc_js__rspack_import_2/* .AsyncMutex */.aD();
        ...
        this.internalSampleRate = bitstream.codecInfo.codec === 'opus'
            ? _codec_js__rspack_import_4/* .OPUS_SAMPLE_RATE */.yo
    ...
    getNumber() {
        ...
        (0,_misc_js__rspack_import_2/* .assert */.vA)(index !== -1);
        return index + 1;
    }
    getNumberOfChannels() {
    ...
    async getDecoderConfig() {
        (0,_misc_js__rspack_import_2/* .assert */.vA)(this.bitstream.codecInfo.codec);
        return {
    ...
    granulePositionToTimestampInSamples(granulePosition) {
        if (this.bitstream.codecInfo.codec === 'opus') {
            (0,_misc_js__rspack_import_2/* .assert */.vA)(this.bitstream.codecInfo.opusInfo);
    ...
    createEncodedPacketFromOggPacket(packet, additional, options) {
        ...
        const { durationInSamples, vorbisBlockSize } = (0,_ogg_misc_js__rspack_import_6/* .extractSampleMetadata */.nL)(packet.data, this.bitstream.codecInfo, additional.vorbisLastBlocksize);
        const encodedPacket = new _packet_js__rspack_import_8/* .EncodedPacket */.Z(options.metadataOnly ? _packet_js__rspack_import_8/* .PLACEHOLDER_DATA */.T : packet.data, 'key', Math.max(0, additional.timestampInSamples) / this.internalSampleRate, durationInSamples / this.internalSampleRate, packet.endPage.headerStartPos + packet.endSegmentIndex, packet.data.byteLength);
    ...
    async getFirstPacket(options) {
        (0,_misc_js__rspack_import_2/* .assert */.vA)(this.bitstream.lastMetadataPacket);
    ...
    async getPacket(timestamp, options) {
        ...
        const timestampInSamples = (0,_misc_js__rspack_import_2/* .roundIfAlmostInteger */.aI)(timestamp * this.internalSampleRate);
        ...
        outer: while (lowPage.headerStartPos + lowPage.totalSize < high) {
            ...
            while (true) {
                const until = Math.min(searchStartPos + _ogg_reader_js__rspack_import_1/* .MAX_PAGE_SIZE */.H4, high - _ogg_reader_js__rspack_import_1/* .MIN_PAGE_HEADER_SIZE */.b0);
                let searchSlice = this.demuxer.reader.requestSlice(searchStartPos, until - searchStartPos);
                if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(searchSlice))
                    searchSlice = await searchSlice;
                (0,_misc_js__rspack_import_2/* .assert */.vA)(searchSlice);
                const found = (0,_ogg_reader_js__rspack_import_1/* .findNextPageHeader */.v5)(searchSlice, until);
                if (!found) {
                    high = mid + _ogg_reader_js__rspack_import_1/* .MIN_PAGE_HEADER_SIZE */.b0;
                    continue outer;
                }
                let headerSlice = this.demuxer.reader.requestSliceRange(searchSlice.filePos, _ogg_reader_js__rspack_import_1/* .MIN_PAGE_HEADER_SIZE */.b0, _ogg_reader_js__rspack_import_1/* .MAX_PAGE_HEADER_SIZE */.H9);
                if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(headerSlice))
                    headerSlice = await headerSlice;
                (0,_misc_js__rspack_import_2/* .assert */.vA)(headerSlice);
                const page = (0,_ogg_reader_js__rspack_import_1/* .readPageHeader */.BF)(headerSlice);
                (0,_misc_js__rspack_import_2/* .assert */.vA)(page);
                let pageValid = false;
                if (page.serialNumber === this.bitstream.serialNumber) {
                    ...
                    const bytes = (0,_reader_js__rspack_import_5/* .readBytes */.io)(pageSlice, page.totalSize);
                    const crc = (0,_ogg_misc_js__rspack_import_6/* .computeOggPageCrc */._S)(bytes);
        ...
        while (true) {
            ...
            let slice = this.demuxer.reader.requestSliceRange(nextPos, _ogg_reader_js__rspack_import_1/* .MIN_PAGE_HEADER_SIZE */.b0, _ogg_reader_js__rspack_import_1/* .MAX_PAGE_HEADER_SIZE */.H9);
            if ((0,_misc_js__rspack_import_2/* .isThenable */.Qg)(slice))
                slice = await slice;
            (0,_misc_js__rspack_import_2/* .assert */.vA)(slice);
            const nextPage = (0,_ogg_reader_js__rspack_import_1/* .readPageHeader */.BF)(slice);
            (0,_misc_js__rspack_import_2/* .assert */.vA)(nextPage);
            currentPage = nextPage;
            if (currentPage.serialNumber === this.bitstream.serialNumber) {
                previousPages.push(currentPage);
            }
        }
        (0,_misc_js__rspack_import_2/* .assert */.vA)(currentPage.granulePosition !== -1);
        ...
        if (currentPage.headerStartPos === startPosition.startPage.headerStartPos) {
            ...
            if (nextPosition) {
                ...
                (0,_misc_js__rspack_import_2/* .assert */.vA)(endPosition);
        ...
        while (currentPage !== null) {
            (0,_misc_js__rspack_import_2/* .assert */.vA)(currentSegmentIndex !== null);
            ...
            if (!skipPacket) {
                ...
                (0,_misc_js__rspack_import_2/* .assert */.vA)(encodedPacket);
                let encodedPacketMetadata = this.encodedPacketToMetadata.get(encodedPacket);
                (0,_misc_js__rspack_import_2/* .assert */.vA)(encodedPacketMetadata);
    ...
    async getPacketSequential(timestamp, options) {
        ...
        try {
            ...
            const index = (0,_misc_js__rspack_import_2/* .binarySearchLessOrEqual */.eE)(this.sequentialScanCache, timestampInSamples, x => x.timestampInSamples);
            let currentPacket;
            if (index !== -1) {
            ...
            while (currentPacket && currentPacket.timestamp < timestamp) {
                ...
                if (i === 100) {
                    ...
                    (0,_misc_js__rspack_import_2/* .assert */.vA)(metadata);
                    if (this.sequentialScanCache.length > 0) {
                        // If we reach this case, we must be at the end of the cache
                        (0,_misc_js__rspack_import_2/* .assert */.vA)((0,_misc_js__rspack_import_2/* .last */._g)(this.sequentialScanCache).timestampInSamples <= metadata.timestampInSamples);
                    }
...
const findPacketStartPosition = (pageList, endPage, endSegmentIndex) => {
    ...
    outer: while (true) {
        ...
        (0,_misc_js__rspack_import_2/* .assert */.vA)(segmentIndex === -1);
        ...
        const previousPage = (0,_misc_js__rspack_import_2/* .findLast */.Uk)(pageList, x => x.headerStartPos < page.headerStartPos);
        if (!previousPage) {
            return null;
        }
        page = previousPage;
...
const findPreviousPacketEndPosition = (pageList, startPage, startSegmentIndex) => {
    ...
    const previousPage = (0,_misc_js__rspack_import_2/* .findLast */.Uk)(pageList, x => x.headerStartPos < startPage.headerStartPos);
    if (!previousPage) {
        return null;
    }
...
9730(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Ob: () => (buildOggMimeType),
  Zk: () => (OGGS),
  _S: () => (computeOggPageCrc),
  nL: () => (extractSampleMetadata)
});
/* import */ var _codec_data_js__rspack_import_1 = __webpack_require__(6297);
/* import */ var _misc_js__rspack_import_0 = __webpack_require__(3912);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
...
const computeOggPageCrc = (bytes) => {
    const view = (0,_misc_js__rspack_import_0/* .toDataView */.Zc)(bytes);
...
const extractSampleMetadata = (data, codecInfo, vorbisLastBlocksize) => {
    ...
    if (data.length > 0) {
        ...
        if (codecInfo.codec === 'vorbis') {
            (0,_misc_js__rspack_import_0/* .assert */.vA)(codecInfo.vorbisInfo);
            const vorbisModeCount = codecInfo.vorbisInfo.modeBlockflags.length;
            const bitCount = (0,_misc_js__rspack_import_0/* .ilog */.al)(vorbisModeCount - 1);
            ...
            const toc = (0,_codec_data_js__rspack_import_1/* .parseOpusTocByte */.ls)(data);
...
9841(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  BF: () => (readPageHeader),
  H4: () => (MAX_PAGE_SIZE),
  H9: () => (MAX_PAGE_HEADER_SIZE),
  b0: () => (MIN_PAGE_HEADER_SIZE),
  v5: () => (findNextPageHeader)
});
/* import */ var _reader_js__rspack_import_0 = __webpack_require__(7735);
/* import */ var _ogg_misc_js__rspack_import_1 = __webpack_require__(9730);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
const readPageHeader = (slice) => {
    const startPos = slice.filePos;
    const capturePattern = (0,_reader_js__rspack_import_0/* .readU32Le */.aJ)(slice);
    if (capturePattern !== _ogg_misc_js__rspack_import_1/* .OGGS */.Zk) {
        return null;
    }
    slice.skip(1); // Version
    const headerType = (0,_reader_js__rspack_import_0/* .readU8 */.eo)(slice);
    const granulePosition = (0,_reader_js__rspack_import_0/* .readI64Le */.TH)(slice);
    const serialNumber = (0,_reader_js__rspack_import_0/* .readU32Le */.aJ)(slice);
    const sequenceNumber = (0,_reader_js__rspack_import_0/* .readU32Le */.aJ)(slice);
    const checksum = (0,_reader_js__rspack_import_0/* .readU32Le */.aJ)(slice);
    const numberPageSegments = (0,_reader_js__rspack_import_0/* .readU8 */.eo)(slice);
    const lacingValues = new Uint8Array(numberPageSegments);
    for (let i = 0; i < numberPageSegments; i++) {
        lacingValues[i] = (0,_reader_js__rspack_import_0/* .readU8 */.eo)(slice);
    }
...
const findNextPageHeader = (slice, until) => {
    while (slice.filePos < until - (4 - 1)) { // Size of word minus 1
        const word = (0,_reader_js__rspack_import_0/* .readU32Le */.aJ)(slice);
        ...
        slice.skip(-4);
        if (word === _ogg_misc_js__rspack_import_1/* .OGGS */.Zk) {
...
3936(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  T: () => (PLACEHOLDER_DATA),
  Z: () => (EncodedPacket)
});
...
class EncodedPacket {
    ...
    get microsecondTimestamp() {
        return Math.trunc(_misc_js__rspack_import_0/* .SECOND_TO_MICROSECOND_FACTOR */.MW * this.timestamp);
    }
    /** The duration of this packet in microseconds. */
    get microsecondDuration() {
        return Math.trunc(_misc_js__rspack_import_0/* .SECOND_TO_MICROSECOND_FACTOR */.MW * this.duration);
    }
...
7735(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Ar: () => (readI32Be),
  B5: () => (readI64Be),
  IM: () => (readU64),
...
/* import */ var _input_js__rspack_import_0 = __webpack_require__(2030);
/* import */ var _misc_js__rspack_import_1 = __webpack_require__(3912);
/* import */ var _source_js__rspack_import_2 = __webpack_require__(4709);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
...
class Reader {
    ...
    requestSlice(start, length) {
        if (this.source._disposed) {
            throw new _input_js__rspack_import_0/* .InputDisposedError */.QO();
        }
        if (start < 0) {
            return null;
        }
        ...
        if (length === 0) {
            ...
            return new FileSlice(buffer, (0,_misc_js__rspack_import_1/* .toDataView */.Zc)(buffer), 0, start, start);
        }
        const end = start + length;
        const result = this.source._read(start, end, _source_js__rspack_import_2/* .DEFAULT_MIN_READ_POSITION */.oV, _source_js__rspack_import_2/* .DEFAULT_MAX_READ_POSITION */.el);
        if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(result)) {
    ...
    requestSliceRange(start, minLength, maxLength) {
        ...
        if (this.fileSizeNonStrict !== null) {
            return this.requestSlice(start, (0,_misc_js__rspack_import_1/* .clamp */.qE)(this.fileSizeNonStrict - start, minLength, maxLength));
        }
        else {
            ...
            const handleAttempt = (attempt) => {
                ...
                (0,_misc_js__rspack_import_1/* .assert */.vA)(this.fileSizeNonStrict !== null);
                return this.requestSlice(start, (0,_misc_js__rspack_import_1/* .clamp */.qE)(this.fileSizeNonStrict - start, minLength, maxLength));
            };
            if ((0,_misc_js__rspack_import_1/* .isThenable */.Qg)(promisedAttempt)) {
    ...
    requestEntireFile() {
        ...
        return (async () => {
            ...
            return new FileSlice(joined, (0,_misc_js__rspack_import_1/* .toDataView */.Zc)(joined), 0, 0, currentSize);
        })();
    }
}
class FileSlice {
    ...
    static tempFromBytes(bytes) {
        return new FileSlice(bytes, (0,_misc_js__rspack_import_1/* .toDataView */.Zc)(bytes), 0, 0, bytes.length);
    }
    get length() {
...
const readU24Be = (slice) => {
    ...
    const value = (0,_misc_js__rspack_import_1/* .getUint24 */.dq)(slice.view, slice.bufferPos, false);
    slice.bufferPos += 3;
    return value;
};
...
const readAllLines = (slice, length, options) => {
    const text = _misc_js__rspack_import_1/* .textDecoder.decode */.su.decode(readBytes(slice, length));
